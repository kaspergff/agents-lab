...
var LIST_STORED_MCP_CLIENTS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var GET_STORED_MCP_CLIENT_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, storedMCPClientId, status, requestContext }) => {
    try {
      ...
      chunkGZ4HWZWE_cjs.assertStoredResourceScope(mcpClient, await chunkGZ4HWZWE_cjs.getStoredResourceScope(mastra, requestContext));
      return mcpClient;
    } catch (error) {
...
var CREATE_STORED_MCP_CLIENT_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients",
  responseType: "json",
...
var UPDATE_STORED_MCP_CLIENT_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "PATCH",
  path: "/stored/mcp-clients/:storedMCPClientId",
  responseType: "json",
  pathParamSchema: chunkWIOYCLJC_cjs.storedMCPClientIdPathParams,
...
var DELETE_STORED_MCP_CLIENT_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "DELETE",
  path: "/stored/mcp-clients/:storedMCPClientId",
  responseType: "json",
  pathParamSchema: chunkWIOYCLJC_cjs.storedMCPClientIdPathParams,
...
//# sourceMappingURL=chunk-UZ43QCIA.cjs.map
//# sourceMappingURL=chunk-UZ43QCIA.cjs.map