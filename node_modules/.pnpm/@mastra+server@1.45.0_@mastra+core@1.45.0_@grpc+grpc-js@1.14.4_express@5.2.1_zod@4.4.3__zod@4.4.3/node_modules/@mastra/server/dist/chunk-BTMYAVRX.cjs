...
var LIST_STORED_PROMPT_BLOCKS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var GET_STORED_PROMPT_BLOCK_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, storedPromptBlockId, status, requestContext }) => {
    try {
      ...
      chunkGZ4HWZWE_cjs.assertStoredResourceScope(promptBlock, await chunkGZ4HWZWE_cjs.getStoredResourceScope(mastra, requestContext));
...
var CREATE_STORED_PROMPT_BLOCK_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/stored/prompt-blocks",
  responseType: "json",
...
var UPDATE_STORED_PROMPT_BLOCK_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "PATCH",
  path: "/stored/prompt-blocks/:storedPromptBlockId",
  responseType: "json",
  pathParamSchema: chunkIABGFWY2_cjs.storedPromptBlockIdPathParams,
...
var DELETE_STORED_PROMPT_BLOCK_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "DELETE",
  path: "/stored/prompt-blocks/:storedPromptBlockId",
  responseType: "json",
  pathParamSchema: chunkIABGFWY2_cjs.storedPromptBlockIdPathParams,
...
//# sourceMappingURL=chunk-BTMYAVRX.cjs.map
//# sourceMappingURL=chunk-BTMYAVRX.cjs.map