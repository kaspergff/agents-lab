...
var OpenAICompatibleChatLanguageModel = class {
  ...
  constructor(modelId, settings, config) {
    ...
    this.failedResponseHandler = chunkFEUXFWF5_cjs.createJsonErrorResponseHandler(errorStructure);
...
var OpenAICompatibleImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkFEUXFWF5_cjs.postJsonToApi({
      ...
      failedResponseHandler: chunkFEUXFWF5_cjs.createJsonErrorResponseHandler(
...
function createXai(options = {}) {
  var _a;
  const baseURL = chunkFEUXFWF5_cjs.withoutTrailingSlash(
...
exports.xai = xai;
//# sourceMappingURL=dist-M3P3YMJP.cjs.map
//# sourceMappingURL=dist-M3P3YMJP.cjs.map