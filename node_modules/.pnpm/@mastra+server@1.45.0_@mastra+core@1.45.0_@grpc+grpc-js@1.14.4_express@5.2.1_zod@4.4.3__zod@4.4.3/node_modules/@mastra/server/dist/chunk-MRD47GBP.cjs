...
var chunkFEUXFWF5_cjs = require('./chunk-FEUXFWF5.cjs');
var zod = require('zod');
            ...
            switch (part.type) {
              ...
              case "image": {
                return {
                  type: "image_url",
                  image_url: {
                    url: part.image instanceof URL ? part.image.toString() : `data:${(_a = part.mimeType) != null ? _a : "image/jpeg"};base64,${chunkFEUXFWF5_cjs.convertUint8ArrayToBase64(part.image)}`,
              ...
              case "file": {
                if (part.data instanceof URL) {
                  throw new chunkFEUXFWF5_cjs.UnsupportedFunctionalityError({
...
var openaiFailedResponseHandler = chunkFEUXFWF5_cjs.createJsonErrorResponseHandler({
...
var OpenAIChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    } = await chunkFEUXFWF5_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunkFEUXFWF5_cjs.combineHeaders(this.config.headers(), options.headers),
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkFEUXFWF5_cjs.createJsonResponseHandler(
      ...
      toolCalls: this.settings.useLegacyFunctionCalling && choice.message.function_call ? [
        {
          ...
          toolCallId: chunkFEUXFWF5_cjs.generateId(),
        ...
        return {
          toolCallType: "function",
          toolCallId: (_a2 = toolCall.id) != null ? _a2 : chunkFEUXFWF5_cjs.generateId(),
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkFEUXFWF5_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkFEUXFWF5_cjs.createEventSourceResponseHandler(
        ...
        new TransformStream({
          transform(chunk, controller) {
            ...
            const mappedToolCalls = useLegacyFunctionCalling && delta.function_call != null ? [
              {
                type: "function",
                id: chunkFEUXFWF5_cjs.generateId(),
              ...
              for (const toolCallDelta of mappedToolCalls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.type !== "function") {
                    throw new chunkFEUXFWF5_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunkFEUXFWF5_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-call",
                        toolCallType: "function",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunkFEUXFWF5_cjs.generateId(),
                        toolName: toolCall2.function.name,
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunkFEUXFWF5_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-call",
                    toolCallType: "function",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunkFEUXFWF5_cjs.generateId(),
                    toolName: toolCall.function.name,
                    args: toolCall.function.arguments
                  });
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunkFEUXFWF5_cjs.InvalidPromptError({
...
var OpenAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkFEUXFWF5_cjs.TooManyEmbeddingValuesForCallError({
    ...
    const { responseHeaders, value: response } = await chunkFEUXFWF5_cjs.postJsonToApi({
      ...
      headers: chunkFEUXFWF5_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: values,
...
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkFEUXFWF5_cjs.postJsonToApi({
      url: this.config.url({
...
var OpenAITranscriptionModel = class {
  ...
  getArgs({
    ...
    var _a, _b, _c, _d, _e;
    const warnings = [];
    const openAIOptions = chunkFEUXFWF5_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
      schema: openAIProviderOptionsSchema
    });
    const formData = new FormData();
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkFEUXFWF5_cjs.convertBase64ToUint8Array(audio)]);
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkFEUXFWF5_cjs.postFormDataToApi({
      url: this.config.url({
          ...
          content: content.map((part, index) => {
            ...
            switch (part.type) {
              ...
              case "image": {
                return {
                  type: "input_image",
                  image_url: part.image instanceof URL ? part.image.toString() : `data:${(_a = part.mimeType) != null ? _a : "image/jpeg"};base64,${chunkFEUXFWF5_cjs.convertUint8ArrayToBase64(part.image)}`,
                  // OpenAI specific extension: image detail
                  detail: (_c = (_b = part.providerMetadata) == null ? void 0 : _b.openai) == null ? void 0 : _c.imageDetail
                };
              }
...
var OpenAIResponsesLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error) {
      throw new chunkFEUXFWF5_cjs.APICallError({
    ...
    return {
      ...
      sources: outputTextElements.flatMap(
        (content) => content.annotations.map((annotation) => {
          ...
          return {
            sourceType: "url",
            id: (_c2 = (_b2 = (_a2 = this.config).generateId) == null ? void 0 : _b2.call(_a2)) != null ? _c2 : chunkFEUXFWF5_cjs.generateId(),
            url: annotation.url,
          ...
          transform(chunk, controller) {
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              controller.enqueue({
                ...
                source: {
                  sourceType: "url",
                  id: (_h = (_g = (_f = self.config).generateId) == null ? void 0 : _g.call(_f)) != null ? _h : chunkFEUXFWF5_cjs.generateId(),
...
var OpenAISpeechModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: requestBody,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkFEUXFWF5_cjs.createBinaryResponseHandler(),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    return {
...
function createOpenAI(options = {}) {
  var _a, _b, _c;
  const baseURL = (_a = chunkFEUXFWF5_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.openai.com/v1";
  const compatibility = (_b = options.compatibility) != null ? _b : "compatible";
  const providerName = (_c = options.name) != null ? _c : "openai";
  const getHeaders = () => ({
    Authorization: `Bearer ${chunkFEUXFWF5_cjs.loadApiKey({
...
//# sourceMappingURL=chunk-MRD47GBP.cjs.map
//# sourceMappingURL=chunk-MRD47GBP.cjs.map