...
async function listWorkflowsFromSystem({ mastra, workflowId }) {
  ...
  let workflow;
  workflow = chunkGZ4HWZWE_cjs.WorkflowRegistry.getWorkflow(workflowId);
  if (!workflow) {
    try {
...
var LIST_WORKFLOWS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/workflows",
  responseType: "json",
  ...
  handler: (async ({ mastra, partial, requestContext }) => {
    try {
      ...
      const _workflows = Object.entries(workflows).reduce((acc, [key, workflow]) => {
        acc[key] = chunkGZ4HWZWE_cjs.getWorkflowInfo(workflow, isPartial);
        return acc;
      }, {});
      ...
      if (fgaProvider) {
        ...
        const accessible = await fgaProvider.filterAccessible(
          ...
          workflowList,
          "workflow",
          chunkRVD3DGBZ_cjs.MastraFGAPermissions.WORKFLOWS_READ
        );
...
var GET_WORKFLOW_BY_ID_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  ...
  handler: (async ({ mastra, workflowId }) => {
    try {
      ...
      return chunkGZ4HWZWE_cjs.getWorkflowInfo(workflow);
    } catch (error) {
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting workflow");
    }
  })
});
var LIST_WORKFLOW_RUNS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var GET_WORKFLOW_RUN_BY_ID_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/workflows/:workflowId/runs/:runId",
  responseType: "json",
  pathParamSchema: chunkXOGNYKAF_cjs.workflowRunPathParams,
  ...
  handler: async ({ mastra, workflowId, runId, fields, withNestedWorkflows, requestContext }) => {
    try {
      ...
      await chunkRVD3DGBZ_cjs.validateRunOwnership(run, effectiveResourceId);
      return run;
    } catch (error) {
...
var DELETE_WORKFLOW_RUN_BY_ID_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "DELETE",
  path: "/workflows/:workflowId/runs/:runId",
  responseType: "json",
  pathParamSchema: chunkXOGNYKAF_cjs.workflowRunPathParams,
...
var CREATE_WORKFLOW_RUN_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var STREAM_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESUME_STREAM_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var START_ASYNC_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/workflows/:workflowId/start-async",
  responseType: "json",
  pathParamSchema: chunkXOGNYKAF_cjs.workflowIdPathParams,
  queryParamSchema: chunkDIG2K5CV_cjs.optionalRunIdSchema,
  bodySchema: chunkXOGNYKAF_cjs.startAsyncWorkflowBodySchema,
...
var START_WORKFLOW_RUN_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var OBSERVE_STREAM_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESUME_ASYNC_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESUME_NO_WAIT_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESUME_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESTART_ASYNC_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/workflows/:workflowId/restart-async",
  responseType: "json",
  pathParamSchema: chunkXOGNYKAF_cjs.workflowIdPathParams,
  queryParamSchema: chunkDIG2K5CV_cjs.runIdSchema,
  bodySchema: chunkXOGNYKAF_cjs.restartBodySchema,
  responseSchema: chunkXOGNYKAF_cjs.workflowExecutionResultSchema,
...
var RESTART_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESTART_ALL_ACTIVE_WORKFLOW_RUNS_ASYNC_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESTART_ALL_ACTIVE_WORKFLOW_RUNS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var TIME_TRAVEL_ASYNC_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/workflows/:workflowId/time-travel-async",
  responseType: "json",
  pathParamSchema: chunkXOGNYKAF_cjs.workflowIdPathParams,
  queryParamSchema: chunkDIG2K5CV_cjs.runIdSchema,
  bodySchema: chunkXOGNYKAF_cjs.timeTravelBodySchema,
  responseSchema: chunkXOGNYKAF_cjs.workflowExecutionResultSchema,
...
var TIME_TRAVEL_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var TIME_TRAVEL_STREAM_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async ({ mastra, workflowId, runId, requestContext, ...params }) => {
    try {
      ...
      await chunkRVD3DGBZ_cjs.validateRunOwnership(existingRun, effectiveResourceId);
      const serverCache = mastra.getServerCache();
...
var CANCEL_WORKFLOW_RUN_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var STREAM_LEGACY_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var OBSERVE_STREAM_LEGACY_WORKFLOW_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var EXECUTE_WORKFLOW_STEP_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RECEIVE_WORKFLOW_EVENT_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
