...
var LIST_STORED_SCORERS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/stored/scorers",
  responseType: "json",
...
var GET_STORED_SCORER_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, storedScorerId, status, requestContext }) => {
    try {
      ...
      chunkGZ4HWZWE_cjs.assertStoredResourceScope(scorer, await chunkGZ4HWZWE_cjs.getStoredResourceScope(mastra, requestContext));
      return scorer;
    } catch (error) {
...
var CREATE_STORED_SCORER_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/stored/scorers",
  responseType: "json",
...
var UPDATE_STORED_SCORER_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "PATCH",
  path: "/stored/scorers/:storedScorerId",
  responseType: "json",
  pathParamSchema: chunkTD4U2UEE_cjs.storedScorerIdPathParams,
...
var DELETE_STORED_SCORER_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "DELETE",
  path: "/stored/scorers/:storedScorerId",
  responseType: "json",
  pathParamSchema: chunkTD4U2UEE_cjs.storedScorerIdPathParams,
...
//# sourceMappingURL=chunk-IRJJ2JJG.cjs.map
//# sourceMappingURL=chunk-IRJJ2JJG.cjs.map