...
var LIST_SCORER_VERSIONS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var CREATE_SCORER_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/stored/scorers/:scorerId/versions",
  requiresAuth: true,
  responseType: "json",
...
var GET_SCORER_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var ACTIVATE_SCORER_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESTORE_SCORER_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var DELETE_SCORER_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "DELETE",
  path: "/stored/scorers/:scorerId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
...
var COMPARE_SCORER_VERSIONS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
//# sourceMappingURL=chunk-ONBABU5V.cjs.map
//# sourceMappingURL=chunk-ONBABU5V.cjs.map