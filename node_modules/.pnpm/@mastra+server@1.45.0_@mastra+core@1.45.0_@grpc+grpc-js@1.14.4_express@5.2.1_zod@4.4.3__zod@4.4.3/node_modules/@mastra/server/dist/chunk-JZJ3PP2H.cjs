...
var LIST_MCP_CLIENT_VERSIONS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var CREATE_MCP_CLIENT_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients/:mcpClientId/versions",
  requiresAuth: true,
  responseType: "json",
...
var GET_MCP_CLIENT_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var ACTIVATE_MCP_CLIENT_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var RESTORE_MCP_CLIENT_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
...
var DELETE_MCP_CLIENT_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "DELETE",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
...
var COMPARE_MCP_CLIENT_VERSIONS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
//# sourceMappingURL=chunk-JZJ3PP2H.cjs.map
//# sourceMappingURL=chunk-JZJ3PP2H.cjs.map