...
var LIST_DATASETS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/datasets",
  responseType: "json",
...
var CREATE_DATASET_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/datasets",
  responseType: "json",
  bodySchema: chunkEVIEMZPA_cjs.createDatasetBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.datasetResponseSchema,
...
var GET_DATASET_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  responseSchema: chunkEVIEMZPA_cjs.datasetResponseSchema.nullable(),
...
var UPDATE_DATASET_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.updateDatasetBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.datasetResponseSchema,
...
var DELETE_DATASET_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
...
var LIST_ITEMS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  queryParamSchema: chunkEVIEMZPA_cjs.listItemsQuerySchema,
  responseSchema: chunkEVIEMZPA_cjs.listItemsResponseSchema,
...
var ADD_ITEM_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/items",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.addItemBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.datasetItemResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    assertDatasetsAvailable();
    try {
      const { input, groundTruth, requestContext, metadata, source, expectedTrajectory } = params;
      const ds = await mastra.datasets.get({ id: datasetId });
...
var GET_ITEM_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetAndItemIdPathParams,
  responseSchema: chunkEVIEMZPA_cjs.datasetItemResponseSchema.nullable(),
...
var UPDATE_ITEM_ROUTE = chunkG54X6VE6_cjs.createRoute({
  ...
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetAndItemIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.updateItemBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.datasetItemResponseSchema,
  ...
  handler: async ({ mastra, datasetId, itemId, ...params }) => {
    assertDatasetsAvailable();
    try {
      const { input, groundTruth, requestContext, metadata, expectedTrajectory } = params;
      const ds = await mastra.datasets.get({ id: datasetId });
...
var LIST_ALL_EXPERIMENTS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/experiments",
  responseType: "json",
  queryParamSchema: chunkEVIEMZPA_cjs.paginationQuerySchema,
  responseSchema: chunkEVIEMZPA_cjs.listExperimentsResponseSchema,
...
var EXPERIMENT_REVIEW_SUMMARY_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/experiments/review-summary",
  responseType: "json",
  responseSchema: chunkEVIEMZPA_cjs.reviewSummaryResponseSchema,
...
var LIST_EXPERIMENTS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var TRIGGER_EXPERIMENT_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/experiments",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.triggerExperimentBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.experimentSummaryResponseSchema,
...
var GET_EXPERIMENT_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/experiments/:experimentId",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetAndExperimentIdPathParams,
  responseSchema: chunkEVIEMZPA_cjs.experimentResponseSchema.nullable(),
...
var LIST_EXPERIMENT_RESULTS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/experiments/:experimentId/results",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetAndExperimentIdPathParams,
  queryParamSchema: chunkEVIEMZPA_cjs.paginationQuerySchema,
  responseSchema: chunkEVIEMZPA_cjs.listExperimentResultsResponseSchema,
...
var UPDATE_EXPERIMENT_RESULT_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId/experiments/:experimentId/results/:resultId",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.experimentResultIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.updateExperimentResultBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.experimentResultResponseSchema,
...
var COMPARE_EXPERIMENTS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/compare",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.compareExperimentsBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.comparisonResponseSchema,
...
var LIST_DATASET_VERSIONS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
...
var LIST_ITEM_VERSIONS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId/history",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetAndItemIdPathParams,
  responseSchema: chunkEVIEMZPA_cjs.listItemVersionsResponseSchema,
...
var GET_ITEM_VERSION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId/versions/:datasetVersion",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetItemVersionPathParams,
  responseSchema: chunkEVIEMZPA_cjs.datasetItemResponseSchema.nullable(),
...
var BATCH_INSERT_ITEMS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/items/batch",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.batchInsertItemsBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.batchInsertItemsResponseSchema,
...
var BATCH_DELETE_ITEMS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId/items/batch",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.batchDeleteItemsBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.batchDeleteItemsResponseSchema,
...
var GENERATE_ITEMS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/generate-items",
  responseType: "json",
  pathParamSchema: chunkEVIEMZPA_cjs.datasetIdPathParams,
  bodySchema: chunkEVIEMZPA_cjs.generateItemsBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.generateItemsResponseSchema,
...
var CLUSTER_FAILURES_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/datasets/cluster-failures",
  responseType: "json",
  bodySchema: chunkEVIEMZPA_cjs.clusterFailuresBodySchema,
  responseSchema: chunkEVIEMZPA_cjs.clusterFailuresResponseSchema,
...
//# sourceMappingURL=chunk-NIM337G7.cjs.map
//# sourceMappingURL=chunk-NIM337G7.cjs.map