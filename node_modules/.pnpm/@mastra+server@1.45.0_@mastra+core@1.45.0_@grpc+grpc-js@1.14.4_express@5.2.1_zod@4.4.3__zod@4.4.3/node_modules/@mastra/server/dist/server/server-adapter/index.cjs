...
var chunkLGWHUDLR_cjs = require('../../chunk-LGWHUDLR.cjs');
...
function getBuiltInRouteFGAConfig(route) {
  ...
  const permission = chunkLGWHUDLR_cjs.getEffectivePermission(route);
  if (!permission) {
    return null;
  }
...
function getRoutePermissions(route) {
  return [chunkLGWHUDLR_cjs.getEffectivePermission(route), route.fga?.permission].flatMap((value) => Array.isArray(value) ? value : [value]).filter((permission) => Boolean(permission));
}
...
var MastraServer = class _MastraServer extends server.MastraServerBase {
  ...
  constructor({
    ...
    this.tools = tools;
    this.prefix = chunkGZ4HWZWE_cjs.normalizeRoutePath(prefix);
  ...
  checkRoutePermission(route, userPermissions, hasPermissionFn, requestContext) {
    ...
    const requiredPermission = chunkLGWHUDLR_cjs.getEffectivePermission(route);
...
Ensure @mastra/core is updated to a version that includes EE support.`
  ...
  async validateFGAPolicyCoverage() {
    ...
    const routes = [...chunkLGWHUDLR_cjs.SERVER_ROUTES, ...customRoutes];
  ...
  buildOpenAPISpec(config, prefix) {
    const openApiSpec = chunkG54X6VE6_cjs.generateOpenAPIDocument(chunkLGWHUDLR_cjs.SERVER_ROUTES, config);
    if (prefix) {
    ...
    if (allCustomRoutes && allCustomRoutes.length > 0) {
      const customPaths = chunkG54X6VE6_cjs.convertCustomRoutesToOpenAPIPaths(allCustomRoutes);
      if (prefix) {
  ...
  async registerRoutes() {
    for (const route of chunkLGWHUDLR_cjs.SERVER_ROUTES) {
...
async function checkRouteFGA(mastra, route, requestContext, params) {
  ...
  const effectivePermission = route.path ? chunkLGWHUDLR_cjs.getEffectivePermission(route) : null;
...
Object.defineProperty(exports, "SERVER_ROUTES", {
  enumerable: true,
  get: function () { return chunkLGWHUDLR_cjs.SERVER_ROUTES; }
});
Object.defineProperty(exports, "deriveAction", {
  enumerable: true,
  get: function () { return chunkLGWHUDLR_cjs.deriveAction; }
});
Object.defineProperty(exports, "derivePermission", {
  enumerable: true,
  get: function () { return chunkLGWHUDLR_cjs.derivePermission; }
});
Object.defineProperty(exports, "extractResource", {
  enumerable: true,
  get: function () { return chunkLGWHUDLR_cjs.extractResource; }
});
Object.defineProperty(exports, "getEffectivePermission", {
  enumerable: true,
  get: function () { return chunkLGWHUDLR_cjs.getEffectivePermission; }
});
Object.defineProperty(exports, "WorkflowRegistry", {
  enumerable: true,
  get: function () { return chunkGZ4HWZWE_cjs.WorkflowRegistry; }
});
Object.defineProperty(exports, "normalizeRoutePath", {
  enumerable: true,
  get: function () { return chunkGZ4HWZWE_cjs.normalizeRoutePath; }
});
...
Object.defineProperty(exports, "createPublicRoute", {
  enumerable: true,
  get: function () { return chunkG54X6VE6_cjs.createPublicRoute; }
});
Object.defineProperty(exports, "createRoute", {
  enumerable: true,
  get: function () { return chunkG54X6VE6_cjs.createRoute; }
});
Object.defineProperty(exports, "generateOpenAPIDocument", {
  enumerable: true,
  get: function () { return chunkG54X6VE6_cjs.generateOpenAPIDocument; }
});
Object.defineProperty(exports, "jsonQueryParam", {
  enumerable: true,
  get: function () { return chunkG54X6VE6_cjs.jsonQueryParam; }
});
Object.defineProperty(exports, "pickParams", {
  enumerable: true,
  get: function () { return chunkG54X6VE6_cjs.pickParams; }
});
Object.defineProperty(exports, "wrapSchemaForQueryParams", {
  enumerable: true,
  get: function () { return chunkG54X6VE6_cjs.wrapSchemaForQueryParams; }
});
