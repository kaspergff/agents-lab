...
async function loadAgentBuilderWorkflows() {
  agentBuilderWorkflowsPromise ??= import('./dist-V3SVSSXI.cjs').then((mod) => mod.agentBuilderWorkflows);
...
async function registerAgentBuilderWorkflows(mastra) {
  ...
  chunkGZ4HWZWE_cjs.WorkflowRegistry.registerTemporaryWorkflows(agentBuilderWorkflows, mastra);
...
var LIST_AGENT_BUILDER_ACTIONS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  ...
  path: "/agent-builder",
  responseType: "json",
  responseSchema: chunkXOGNYKAF_cjs.listWorkflowsResponseSchema,
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.LIST_WORKFLOWS_ROUTE.handler(ctx);
    } catch (error) {
      ...
      chunkGZ4HWZWE_cjs.WorkflowRegistry.cleanup();
    }
  }
});
var GET_AGENT_BUILDER_ACTION_BY_ID_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/agent-builder/:actionId",
  responseType: "json",
  pathParamSchema: chunkL56ROTL6_cjs.actionIdPathParams,
  responseSchema: chunkXOGNYKAF_cjs.workflowInfoSchema,
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      if (actionId && !chunkGZ4HWZWE_cjs.WorkflowRegistry.isAgentBuilderWorkflow(actionId)) {
      ...
      return await chunkU72IZ5BP_cjs.GET_WORKFLOW_BY_ID_ROUTE.handler({ ...ctx, workflowId: actionId });
    } catch (error) {
...
var LIST_AGENT_BUILDER_ACTION_RUNS_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/agent-builder/:actionId/runs",
  responseType: "json",
  pathParamSchema: chunkL56ROTL6_cjs.actionIdPathParams,
  queryParamSchema: chunkXOGNYKAF_cjs.listWorkflowRunsQuerySchema,
  responseSchema: chunkXOGNYKAF_cjs.workflowRunsResponseSchema,
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.LIST_WORKFLOW_RUNS_ROUTE.handler({
        ...ctx,
        workflowId: actionId
      });
    } catch (error) {
...
var GET_AGENT_BUILDER_ACTION_RUN_BY_ID_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "GET",
  path: "/agent-builder/:actionId/runs/:runId",
  responseType: "json",
  pathParamSchema: chunkL56ROTL6_cjs.actionRunPathParams,
  queryParamSchema: chunkXOGNYKAF_cjs.workflowRunResultQuerySchema,
  responseSchema: chunkXOGNYKAF_cjs.workflowRunResultSchema,
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.GET_WORKFLOW_RUN_BY_ID_ROUTE.handler({
        ...ctx,
        workflowId: actionId
      });
    } catch (error) {
...
var CREATE_AGENT_BUILDER_ACTION_RUN_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/agent-builder/:actionId/create-run",
  responseType: "json",
  pathParamSchema: chunkL56ROTL6_cjs.actionIdPathParams,
  queryParamSchema: chunkDIG2K5CV_cjs.optionalRunIdSchema,
  responseSchema: chunkXOGNYKAF_cjs.createWorkflowRunResponseSchema,
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.CREATE_WORKFLOW_RUN_ROUTE.handler({
        ...ctx,
        workflowId: actionId
      });
    } catch (error) {
...
var STREAM_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.STREAM_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId,
        requestContext
      });
...
var START_ASYNC_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  path: "/agent-builder/:actionId/start-async",
  responseType: "json",
  pathParamSchema: chunkL56ROTL6_cjs.actionIdPathParams,
  queryParamSchema: chunkDIG2K5CV_cjs.optionalRunIdSchema,
  bodySchema: chunkL56ROTL6_cjs.startAsyncAgentBuilderBodySchema,
  responseSchema: chunkXOGNYKAF_cjs.workflowExecutionResultSchema,
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.START_ASYNC_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId,
        requestContext
      });
...
var START_AGENT_BUILDER_ACTION_RUN_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  queryParamSchema: chunkDIG2K5CV_cjs.runIdSchema,
  bodySchema: chunkL56ROTL6_cjs.startAsyncAgentBuilderBodySchema,
  responseSchema: chunkXOGNYKAF_cjs.workflowControlResponseSchema,
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.START_WORKFLOW_RUN_ROUTE.handler({
        ...ctx,
        workflowId: actionId,
        requestContext
      });
...
var OBSERVE_STREAM_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.OBSERVE_STREAM_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId
      });
    } catch (error) {
...
var RESUME_ASYNC_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.RESUME_ASYNC_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId,
        requestContext
      });
...
var RESUME_NO_WAIT_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.RESUME_NO_WAIT_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId,
        requestContext
      });
...
var RESUME_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.RESUME_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId,
        requestContext
      });
...
var RESUME_STREAM_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.RESUME_STREAM_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId,
        requestContext
      });
...
var CANCEL_AGENT_BUILDER_ACTION_RUN_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.CANCEL_WORKFLOW_RUN_ROUTE.handler({
        ...ctx,
        workflowId: actionId
      });
    } catch (error) {
...
var STREAM_LEGACY_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.STREAM_LEGACY_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId,
        requestContext
      });
...
var OBSERVE_STREAM_LEGACY_AGENT_BUILDER_ACTION_ROUTE = chunkG54X6VE6_cjs.createRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return await chunkU72IZ5BP_cjs.OBSERVE_STREAM_LEGACY_WORKFLOW_ROUTE.handler({
        ...ctx,
        workflowId: actionId
      });
    } catch (error) {
...
//# sourceMappingURL=chunk-JGWDTZ4A.cjs.map
//# sourceMappingURL=chunk-JGWDTZ4A.cjs.map