...
var anthropicFailedResponseHandler = chunkFEUXFWF5_cjs.createJsonErrorResponseHandler({
...
var AnthropicMessagesLanguageModel = class {
  ...
  async getArgs({
    ...
    const anthropicOptions = chunkFEUXFWF5_cjs.parseProviderOptions({
      provider: "anthropic",
      providerOptions,
  ...
  async getHeaders({
    ...
    return chunkFEUXFWF5_cjs.combineHeaders(
...
function createAnthropic(options = {}) {
  var _a;
  const baseURL = (_a = chunkFEUXFWF5_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.anthropic.com/v1";
  const getHeaders = () => ({
    "anthropic-version": "2023-06-01",
    "x-api-key": chunkFEUXFWF5_cjs.loadApiKey({
...
//# sourceMappingURL=dist-CIZY7VDE.cjs.map
//# sourceMappingURL=dist-CIZY7VDE.cjs.map