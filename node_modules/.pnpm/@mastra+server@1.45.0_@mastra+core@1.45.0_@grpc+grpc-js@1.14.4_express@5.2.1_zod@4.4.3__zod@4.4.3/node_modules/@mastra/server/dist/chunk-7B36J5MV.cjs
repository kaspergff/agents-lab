...
var chunkPU4EHEN2_cjs = require('./chunk-PU4EHEN2.cjs');
...
function createNewRoute(def, config) {
  ...
  return chunkG54X6VE6_cjs.createRoute({
    ...def,
    ...schemas,
    responseType: "json",
    tags: ["Observability"],
...
var LIST_LOGS = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.LIST_LOGS, {
  queryParamSchema: chunkPU4EHEN2_cjs.createObservabilityListQuerySchema(logsFilterSchema, logsOrderBySchema),
  responseSchema: listLogsResponseSchema,
  handler: async ({ mastra, mode, after, limit, ...params }) => {
    const filters = chunkG54X6VE6_cjs.pickParams(logsFilterSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    if (mode === "delta") {
      chunkPU4EHEN2_cjs.assertObservabilityDeltaSupported(observabilityStore, chunkPU4EHEN2_cjs.OBSERVABILITY_LIST_ENDPOINTS.logs);
    ...
    const pagination = chunkG54X6VE6_cjs.pickParams(chunkZNP74O27_cjs.paginationArgsSchema, params);
    const orderBy = chunkG54X6VE6_cjs.pickParams(logsOrderBySchema, params);
    return await observabilityStore.listLogs(
      mode === "page" ? { mode, filters, pagination, orderBy } : { filters, pagination, orderBy }
    );
  }
});
var LIST_SCORES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.LIST_SCORES, {
  queryParamSchema: chunkPU4EHEN2_cjs.createObservabilityListQuerySchema(scoresFilterSchema, scoresOrderBySchema),
  responseSchema: listScoresResponseSchema,
  handler: async ({ mastra, mode, after, limit, ...params }) => {
    const filters = chunkG54X6VE6_cjs.pickParams(scoresFilterSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    if (mode === "delta") {
      chunkPU4EHEN2_cjs.assertObservabilityDeltaSupported(observabilityStore, chunkPU4EHEN2_cjs.OBSERVABILITY_LIST_ENDPOINTS.scores);
    ...
    const pagination = chunkG54X6VE6_cjs.pickParams(chunkZNP74O27_cjs.paginationArgsSchema, params);
    const orderBy = chunkG54X6VE6_cjs.pickParams(scoresOrderBySchema, params);
    return await observabilityStore.listScores(
      mode === "page" ? { mode, filters, pagination, orderBy } : { filters, pagination, orderBy }
    );
  }
});
var CREATE_SCORE = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.CREATE_SCORE, {
...
var GET_SCORE = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_SCORE, {
...
var GET_SCORE_AGGREGATE = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_SCORE_AGGREGATE, {
  bodySchema: getScoreAggregateArgsSchema,
  responseSchema: getScoreAggregateResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getScoreAggregateArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getScoreAggregate(args);
  }
});
var GET_SCORE_BREAKDOWN = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_SCORE_BREAKDOWN, {
  bodySchema: getScoreBreakdownArgsSchema,
  responseSchema: getScoreBreakdownResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getScoreBreakdownArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getScoreBreakdown(args);
  }
});
var GET_SCORE_TIME_SERIES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_SCORE_TIME_SERIES, {
  bodySchema: getScoreTimeSeriesArgsSchema,
  responseSchema: getScoreTimeSeriesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getScoreTimeSeriesArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getScoreTimeSeries(args);
  }
});
var GET_SCORE_PERCENTILES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_SCORE_PERCENTILES, {
  bodySchema: getScorePercentilesArgsSchema,
  responseSchema: getScorePercentilesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getScorePercentilesArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getScorePercentiles(args);
  }
});
var LIST_FEEDBACK = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.LIST_FEEDBACK, {
  queryParamSchema: chunkPU4EHEN2_cjs.createObservabilityListQuerySchema(feedbackFilterSchema, feedbackOrderBySchema),
  responseSchema: listFeedbackResponseSchema,
  handler: async ({ mastra, mode, after, limit, ...params }) => {
    const filters = chunkG54X6VE6_cjs.pickParams(feedbackFilterSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    if (mode === "delta") {
      chunkPU4EHEN2_cjs.assertObservabilityDeltaSupported(observabilityStore, chunkPU4EHEN2_cjs.OBSERVABILITY_LIST_ENDPOINTS.feedback);
    ...
    const pagination = chunkG54X6VE6_cjs.pickParams(chunkZNP74O27_cjs.paginationArgsSchema, params);
    const orderBy = chunkG54X6VE6_cjs.pickParams(feedbackOrderBySchema, params);
    return await observabilityStore.listFeedback(
      mode === "page" ? { mode, filters, pagination, orderBy } : { filters, pagination, orderBy }
    );
  }
});
var CREATE_FEEDBACK = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.CREATE_FEEDBACK, {
...
var GET_FEEDBACK_AGGREGATE = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_FEEDBACK_AGGREGATE, {
  bodySchema: getFeedbackAggregateArgsSchema,
  responseSchema: getFeedbackAggregateResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getFeedbackAggregateArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getFeedbackAggregate(args);
  }
});
var GET_FEEDBACK_BREAKDOWN = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_FEEDBACK_BREAKDOWN, {
  bodySchema: getFeedbackBreakdownArgsSchema,
  responseSchema: getFeedbackBreakdownResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getFeedbackBreakdownArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getFeedbackBreakdown(args);
  }
});
var GET_FEEDBACK_TIME_SERIES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_FEEDBACK_TIME_SERIES, {
  bodySchema: getFeedbackTimeSeriesArgsSchema,
  responseSchema: getFeedbackTimeSeriesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getFeedbackTimeSeriesArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getFeedbackTimeSeries(args);
  }
});
var GET_FEEDBACK_PERCENTILES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_FEEDBACK_PERCENTILES, {
  bodySchema: getFeedbackPercentilesArgsSchema,
  responseSchema: getFeedbackPercentilesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getFeedbackPercentilesArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getFeedbackPercentiles(args);
  }
});
var LIST_METRICS = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.LIST_METRICS, {
  queryParamSchema: chunkPU4EHEN2_cjs.createObservabilityListQuerySchema(metricsFilterSchema, metricsOrderBySchema),
  responseSchema: listMetricsResponseSchema,
  handler: async ({ mastra, mode, after, limit, ...params }) => {
    const filters = chunkG54X6VE6_cjs.pickParams(metricsFilterSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    if (mode === "delta") {
      chunkPU4EHEN2_cjs.assertObservabilityDeltaSupported(observabilityStore, chunkPU4EHEN2_cjs.OBSERVABILITY_LIST_ENDPOINTS.metrics);
    ...
    const pagination = chunkG54X6VE6_cjs.pickParams(chunkZNP74O27_cjs.paginationArgsSchema, params);
    const orderBy = chunkG54X6VE6_cjs.pickParams(metricsOrderBySchema, params);
    return await observabilityStore.listMetrics(
      mode === "page" ? { mode, filters, pagination, orderBy } : { filters, pagination, orderBy }
    );
  }
});
var GET_METRIC_AGGREGATE = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_METRIC_AGGREGATE, {
  bodySchema: getMetricAggregateArgsSchema,
  responseSchema: getMetricAggregateResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getMetricAggregateArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getMetricAggregate(args);
  }
});
var GET_METRIC_BREAKDOWN = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_METRIC_BREAKDOWN, {
  bodySchema: getMetricBreakdownArgsSchema,
  responseSchema: getMetricBreakdownResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getMetricBreakdownArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getMetricBreakdown(args);
  }
});
var GET_METRIC_TIME_SERIES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_METRIC_TIME_SERIES, {
  bodySchema: getMetricTimeSeriesArgsSchema,
  responseSchema: getMetricTimeSeriesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getMetricTimeSeriesArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getMetricTimeSeries(args);
  }
});
var GET_METRIC_PERCENTILES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_METRIC_PERCENTILES, {
  bodySchema: getMetricPercentilesArgsSchema,
  responseSchema: getMetricPercentilesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = chunkG54X6VE6_cjs.pickParams(getMetricPercentilesArgsSchema, params);
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getMetricPercentiles(args);
  }
});
var GET_METRIC_NAMES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_METRIC_NAMES, {
  queryParamSchema: chunkG54X6VE6_cjs.wrapSchemaForQueryParams(getMetricNamesArgsSchema.partial()),
  responseSchema: getMetricNamesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = getMetricNamesArgsSchema.parse(chunkG54X6VE6_cjs.pickParams(getMetricNamesArgsSchema, params));
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getMetricNames(args);
  }
});
var GET_METRIC_LABEL_KEYS = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_METRIC_LABEL_KEYS, {
  queryParamSchema: chunkG54X6VE6_cjs.wrapSchemaForQueryParams(getMetricLabelKeysArgsSchema),
  responseSchema: getMetricLabelKeysResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = getMetricLabelKeysArgsSchema.parse(chunkG54X6VE6_cjs.pickParams(getMetricLabelKeysArgsSchema, params));
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getMetricLabelKeys(args);
  }
});
var GET_METRIC_LABEL_VALUES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_METRIC_LABEL_VALUES, {
  queryParamSchema: chunkG54X6VE6_cjs.wrapSchemaForQueryParams(getMetricLabelValuesArgsSchema),
  responseSchema: getMetricLabelValuesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = getMetricLabelValuesArgsSchema.parse(chunkG54X6VE6_cjs.pickParams(getMetricLabelValuesArgsSchema, params));
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getMetricLabelValues(args);
  }
});
var GET_ENTITY_TYPES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_ENTITY_TYPES, {
...
var GET_ENTITY_NAMES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_ENTITY_NAMES, {
  queryParamSchema: chunkG54X6VE6_cjs.wrapSchemaForQueryParams(getEntityNamesArgsSchema.partial()),
  responseSchema: getEntityNamesResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = getEntityNamesArgsSchema.parse(chunkG54X6VE6_cjs.pickParams(getEntityNamesArgsSchema, params));
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    return await observabilityStore.getEntityNames(args);
  }
});
var GET_SERVICE_NAMES = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_SERVICE_NAMES, {
...
var GET_ENVIRONMENTS = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_ENVIRONMENTS, {
...
var GET_TAGS = createNewRoute(chunkPU4EHEN2_cjs.NEW_ROUTE_DEFS.GET_TAGS, {
  queryParamSchema: chunkG54X6VE6_cjs.wrapSchemaForQueryParams(getTagsArgsSchema.partial()),
  responseSchema: getTagsResponseSchema,
  handler: async ({ mastra, ...params }) => {
    const args = getTagsArgsSchema.parse(chunkG54X6VE6_cjs.pickParams(getTagsArgsSchema, params));
    const observabilityStore = await chunkPU4EHEN2_cjs.getObservabilityStore(mastra);
    try {
...
//# sourceMappingURL=chunk-7B36J5MV.cjs.map
//# sourceMappingURL=chunk-7B36J5MV.cjs.map