// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/quansync/0.2.11/80c02040920fbd1f80e0521f68247e3de68ce8d966700e38ce40b9ed5f8db5e3/node_modules/quansync/dist/index.mjs
...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@standard-community/standard-json/0.3.5/9dbc67da7ef95ab6ba977b83f155ade1f3176d290d47d40a60434eb3472caaac/node_modules/@standard-community/standard-json/dist/index-CLddUTqr.js
...
var getToJsonSchemaFn = async (vendor) => {
  ...
  switch (vendor) {
    case "arktype":
      vendorFnPromise = (await import('./arktype-aI7TBD0R-K3QZAVE2.js')).default();
      break;
    case "effect":
      vendorFnPromise = (await import('./effect-QlVUlMFu-QNLZLGWO.js')).default();
      break;
    case "sury":
      vendorFnPromise = (await import('./sury-CWZTCd75-DZQHKAZF.js')).default();
      break;
    case "typebox":
      vendorFnPromise = (await import('./typebox-Dei93FPO-GOYJ5OUT.js')).default();
      break;
    case "valibot":
      vendorFnPromise = (await import('./valibot--1zFm7rT-ZVGQI7WV.js')).default();
      break;
    case "zod":
      vendorFnPromise = (await import('./zod-Bwrt9trS-GN7ZXBMN.js')).default();
      break;
    default:
...
//# sourceMappingURL=chunk-ZKZOVNT4.js.map
//# sourceMappingURL=chunk-ZKZOVNT4.js.map