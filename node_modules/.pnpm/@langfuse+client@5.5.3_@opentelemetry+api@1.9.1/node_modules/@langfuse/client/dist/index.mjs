...
var ScoreManager = class {
  ...
  create(data) {
    ...
    const scoreData = {
      ...data,
      id: (_a = data.id) != null ? _a : generateUUID(),
      environment: (_b = data.environment) != null ? _b : getEnv("LANGFUSE_TRACING_ENVIRONMENT")
    };
...
var LangfuseClient = class {
  ...
  constructor(params) {
    ...
    const timeoutSeconds = (_g = params == null ? void 0 : params.timeout) != null ? _g : Number((_f = getEnv2("LANGFUSE_TIMEOUT")) != null ? _f : 5);
    this.api = new LangfuseAPIClient4({
