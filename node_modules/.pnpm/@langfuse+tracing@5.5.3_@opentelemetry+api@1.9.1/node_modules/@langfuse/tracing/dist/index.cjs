...
var LangfuseBaseObservation = class {
  constructor(params) {
    ...
    this.otelSpan.setAttributes(
      createObservationAttributes(params.type, (_a = params.attributes) != null ? _a : {})
    );
  }
...
function startActiveObservation(name, fn, options) {
  ...
  return getLangfuseTracer().startActiveSpan(
    ...
    (span) => {
      const claimContext = (0, import_core4.setLangfuseTraceIdInBaggage)(
        import_api2.context.active(),
        span.spanContext().traceId
      );
      return import_api2.context.with(claimContext, () => {
        var _a2;
        try {
          let observation;
          switch (asType) {
...
function observe(fn, options = {}) {
  ...
  const wrappedFunction = function(...args) {
    ...
    const activeContext = (0, import_core4.setLangfuseTraceIdInBaggage)(
      import_api2.trace.setSpan(import_api2.context.active(), observation.otelSpan),
