...
__export(index_exports, {
  ...
  BlobStorageExportFieldGroup: () => BlobStorageExportFieldGroup,
  BlobStorageExportFrequency: () => BlobStorageExportFrequency,
  BlobStorageExportMode: () => BlobStorageExportMode,
  BlobStorageExportSource: () => BlobStorageExportSource,
  ...
  LANGFUSE_TRACE_ID_BAGGAGE_KEY: () => LANGFUSE_TRACE_ID_BAGGAGE_KEY,
  ...
  getLangfuseTraceIdFromBaggage: () => getLangfuseTraceIdFromBaggage,
...
var LangfuseOtelSpanAttributes = /* @__PURE__ */ ((LangfuseOtelSpanAttributes2) => {
  ...
  LangfuseOtelSpanAttributes2["IS_APP_ROOT"] = "langfuse.internal.is_app_root";
...
// src/api/api/resources/blobStorageIntegrations/types/BlobStorageExportSource.ts
var BlobStorageExportSource = {
...
// src/api/api/resources/blobStorageIntegrations/types/BlobStorageExportFieldGroup.ts
var BlobStorageExportFieldGroup = {
  Core: "core",
  Basic: "basic",
  Time: "time",
  Io: "io",
...
__export(legacy_exports, {
  CreateScoreSource: () => CreateScoreSource,
...
var scoreV1_exports = {};
__export(scoreV1_exports, {
  CreateScoreSource: () => CreateScoreSource
});

// src/api/api/resources/legacy/resources/scoreV1/types/CreateScoreSource.ts
var CreateScoreSource = {
  Api: "API",
  Annotation: "ANNOTATION"
};
...
// src/api/api/resources/unstable/index.ts
...
__export(unstable_exports, {
  ...
  EvaluationRuleNullFilterOperator: () => EvaluationRuleNullFilterOperator,
  EvaluationRuleNumberFilterOperator: () => EvaluationRuleNumberFilterOperator,
  EvaluationRuleOptionsFilterOperator: () => EvaluationRuleOptionsFilterOperator,
  EvaluationRuleStatus: () => EvaluationRuleStatus,
  EvaluationRuleStringFilterOperator: () => EvaluationRuleStringFilterOperator,
  EvaluationRuleTarget: () => EvaluationRuleTarget,
  EvaluatorOutputDataType: () => EvaluatorOutputDataType,
  ...
  commons: () => commons_exports2,
  errors: () => errors_exports2,
  evaluationRules: () => evaluationRules_exports,
  evaluators: () => evaluators_exports
});
...
// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleTarget.ts
var EvaluationRuleTarget = {
  Observation: "observation",
  Experiment: "experiment"
};

// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleStatus.ts
var EvaluationRuleStatus = {
  Active: "active",
  Inactive: "inactive",
  Paused: "paused"
};

// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleMappingSource.ts
var EvaluationRuleMappingSource = {
  Input: "input",
  Output: "output",
  Metadata: "metadata",
...
// src/api/api/resources/unstable/resources/commons/types/EvaluatorOutputDataType.ts
var EvaluatorOutputDataType = {
  Numeric: "NUMERIC",
  Boolean: "BOOLEAN",
  Categorical: "CATEGORICAL"
};

// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleStringFilterOperator.ts
var EvaluationRuleStringFilterOperator = {
  Equals: "=",
  Contains: "contains",
...
// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleNumberFilterOperator.ts
var EvaluationRuleNumberFilterOperator = {
  Equals: "=",
  GreaterThan: ">",
  LessThan: "<",
  GreaterThanOrEqual: ">=",
...
// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleOptionsFilterOperator.ts
var EvaluationRuleOptionsFilterOperator = {
  AnyOf: "any of",
  NoneOf: "none of"
};

// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleArrayOptionsFilterOperator.ts
var EvaluationRuleArrayOptionsFilterOperator = {
  AnyOf: "any of",
  NoneOf: "none of",
  AllOf: "all of"
};

// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleBooleanFilterOperator.ts
var EvaluationRuleBooleanFilterOperator = {
  Equals: "=",
  NotEquals: "<>"
};

// src/api/api/resources/unstable/resources/commons/types/EvaluationRuleNullFilterOperator.ts
var EvaluationRuleNullFilterOperator = {
  IsNull: "is null",
  IsNotNull: "is not null"
};

// src/api/api/resources/unstable/resources/errors/index.ts
var errors_exports2 = {};
...
// src/api/api/resources/unstable/resources/errors/types/PublicApiErrorCode.ts
var PublicApiErrorCode = {
...
// src/api/api/resources/unstable/resources/errors/errors/BadRequestError.ts
var BadRequestError = class _BadRequestError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
...
// src/api/api/resources/unstable/resources/errors/errors/UnauthorizedError.ts
var UnauthorizedError2 = class _UnauthorizedError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
      message: "UnauthorizedError",
      statusCode: 401,
...
// src/api/api/resources/unstable/resources/errors/errors/AccessDeniedError.ts
var AccessDeniedError2 = class _AccessDeniedError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
      message: "AccessDeniedError",
      statusCode: 403,
...
// src/api/api/resources/unstable/resources/errors/errors/NotFoundError.ts
var NotFoundError2 = class _NotFoundError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
      message: "NotFoundError",
      statusCode: 404,
...
// src/api/api/resources/unstable/resources/errors/errors/MethodNotAllowedError.ts
var MethodNotAllowedError2 = class _MethodNotAllowedError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
      message: "MethodNotAllowedError",
      statusCode: 405,
...
// src/api/api/resources/unstable/resources/errors/errors/ConflictError.ts
var ConflictError = class _ConflictError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
...
// src/api/api/resources/unstable/resources/errors/errors/UnprocessableContentError.ts
var UnprocessableContentError = class _UnprocessableContentError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
    ...
    Object.setPrototypeOf(this, _UnprocessableContentError.prototype);
  }
};

// src/api/api/resources/unstable/resources/errors/errors/TooManyRequestsError.ts
var TooManyRequestsError = class _TooManyRequestsError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
...
// src/api/api/resources/unstable/resources/errors/errors/InternalServerError.ts
var InternalServerError = class _InternalServerError extends LangfuseAPIError {
  constructor(body, rawResponse) {
    super({
...
// src/api/api/resources/unstable/resources/evaluationRules/client/Client.ts
var EvaluationRules = class {
  constructor(_options) {
    this._options = _options;
  }
  /**
  ...
  async __create(request, requestOptions) {
    ...
    if (_response.error.reason === "status-code") {
      switch (_response.error.statusCode) {
        case 400:
          throw new unstable_exports.BadRequestError(
            _response.error.body,
            _response.rawResponse
          );
        case 401:
          throw new unstable_exports.UnauthorizedError(
            _response.error.body,
            _response.rawResponse
          );
        case 403:
          throw new unstable_exports.AccessDeniedError(
            _response.error.body,
            _response.rawResponse
          );
        case 404:
          throw new unstable_exports.NotFoundError(
            _response.error.body,
            _response.rawResponse
          );
        case 409:
          throw new unstable_exports.ConflictError(
            _response.error.body,
            _response.rawResponse
          );
        case 405:
          throw new unstable_exports.MethodNotAllowedError(
            _response.error.body,
            _response.rawResponse
          );
        case 422:
          throw new unstable_exports.UnprocessableContentError(
            _response.error.body,
            _response.rawResponse
          );
        case 429:
          throw new unstable_exports.TooManyRequestsError(
            _response.error.body,
            _response.rawResponse
          );
        case 500:
          throw new unstable_exports.InternalServerError(
            _response.error.body,
            _response.rawResponse
          );
        case 400:
   ...
   */
  get(evaluationRuleId, requestOptions) {
    return HttpResponsePromise.fromPromise(
      this.__get(evaluationRuleId, requestOptions)
    );
  }
  async __get(evaluationRuleId, requestOptions) {
    var _a2, _b, _c, _d, _e, _f, _g, _h;
    let _headers = mergeHeaders(
      (_a2 = this._options) == null ? void 0 : _a2.headers,
      mergeOnlyDefinedHeaders({
   ...
   *     })
   */
  update(evaluationRuleId, request, requestOptions) {
    return HttpResponsePromise.fromPromise(
      this.__update(evaluationRuleId, request, requestOptions)
    );
  }
  async __update(evaluationRuleId, request, requestOptions) {
    var _a2, _b, _c, _d, _e, _f, _g, _h;
    let _headers = mergeHeaders(
      (_a2 = this._options) == null ? void 0 : _a2.headers,
      mergeOnlyDefinedHeaders({
   ...
   */
  delete(evaluationRuleId, requestOptions) {
    return HttpResponsePromise.fromPromise(
      this.__delete(evaluationRuleId, requestOptions)
    );
  }
  async __delete(evaluationRuleId, requestOptions) {
    var _a2, _b, _c, _d, _e, _f, _g, _h;
    let _headers = mergeHeaders(
      (_a2 = this._options) == null ? void 0 : _a2.headers,
      mergeOnlyDefinedHeaders({
...
// src/api/api/resources/unstable/resources/evaluators/client/Client.ts
var Evaluators = class {
  constructor(_options) {
    this._options = _options;
  }
  /**
   ...
   */
  get(evaluatorId, requestOptions) {
    return HttpResponsePromise.fromPromise(
      this.__get(evaluatorId, requestOptions)
    );
  }
  async __get(evaluatorId, requestOptions) {
    var _a2, _b, _c, _d, _e, _f, _g, _h;
    let _headers = mergeHeaders(
      (_a2 = this._options) == null ? void 0 : _a2.headers,
      mergeOnlyDefinedHeaders({
   ...
   */
  delete(evaluatorId, requestOptions) {
    return HttpResponsePromise.fromPromise(
      this.__delete(evaluatorId, requestOptions)
    );
  }
  async __delete(evaluatorId, requestOptions) {
    var _a2, _b, _c, _d, _e, _f, _g, _h;
    let _headers = mergeHeaders(
      (_a2 = this._options) == null ? void 0 : _a2.headers,
      mergeOnlyDefinedHeaders({
...
// src/api/api/resources/unstable/client/Client.ts
var Unstable = class {
  constructor(_options) {
    this._options = _options;
  }
  get evaluationRules() {
    var _a2;
    return (_a2 = this._evaluationRules) != null ? _a2 : this._evaluationRules = new EvaluationRules(this._options);
  }
  get evaluators() {
    var _a2;
    return (_a2 = this._evaluators) != null ? _a2 : this._evaluators = new Evaluators(this._options);
  }
};
...
var LangfuseAPIClient = class {
  ...
  get unstable() {
    var _a2;
    return (_a2 = this._unstable) != null ? _a2 : this._unstable = new Unstable(this._options);
  }
};
...
var LANGFUSE_TRACE_ID_BAGGAGE_KEY = "langfuse_trace_id";
function getLangfuseTraceIdFromBaggage(context) {
  const baggage = import_api.propagation.getBaggage(context);
  const entry = baggage == null ? void 0 : baggage.getEntry(LANGFUSE_TRACE_ID_BAGGAGE_KEY);
  if (!(entry == null ? void 0 : entry.value)) return void 0;
  return entry.value.toLowerCase();
}
function setLangfuseTraceIdInBaggage(context, traceId) {
  var _a2;
  const normalized = traceId.toLowerCase();
  if (getLangfuseTraceIdFromBaggage(context) === normalized) return context;
  const baggage = (_a2 = import_api.propagation.getBaggage(context)) != null ? _a2 : import_api.propagation.createBaggage();
  const updated = baggage.setEntry(LANGFUSE_TRACE_ID_BAGGAGE_KEY, {
    value: normalized
  });
  return import_api.propagation.setBaggage(context, updated);
}
