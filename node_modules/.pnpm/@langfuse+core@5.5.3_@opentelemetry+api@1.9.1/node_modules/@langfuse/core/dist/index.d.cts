...
type index$z_AnnotationQueue = AnnotationQueue;
type index$z_AnnotationQueueAssignmentRequest = AnnotationQueueAssignmentRequest;
type index$z_AnnotationQueueItem = AnnotationQueueItem;
declare const index$z_AnnotationQueueObjectType: typeof AnnotationQueueObjectType;
declare const index$z_AnnotationQueueStatus: typeof AnnotationQueueStatus;
type index$z_CreateAnnotationQueueAssignmentResponse = CreateAnnotationQueueAssignmentResponse;
type index$z_CreateAnnotationQueueItemRequest = CreateAnnotationQueueItemRequest;
type index$z_CreateAnnotationQueueRequest = CreateAnnotationQueueRequest;
type index$z_DeleteAnnotationQueueAssignmentResponse = DeleteAnnotationQueueAssignmentResponse;
type index$z_DeleteAnnotationQueueItemResponse = DeleteAnnotationQueueItemResponse;
type index$z_GetAnnotationQueueItemsRequest = GetAnnotationQueueItemsRequest;
type index$z_GetAnnotationQueuesRequest = GetAnnotationQueuesRequest;
type index$z_PaginatedAnnotationQueueItems = PaginatedAnnotationQueueItems;
type index$z_PaginatedAnnotationQueues = PaginatedAnnotationQueues;
type index$z_UpdateAnnotationQueueItemRequest = UpdateAnnotationQueueItemRequest;
declare namespace index$z {
  export { type index$z_AnnotationQueue as AnnotationQueue, type index$z_AnnotationQueueAssignmentRequest as AnnotationQueueAssignmentRequest, type index$z_AnnotationQueueItem as AnnotationQueueItem, index$z_AnnotationQueueObjectType as AnnotationQueueObjectType, index$z_AnnotationQueueStatus as AnnotationQueueStatus, type index$z_CreateAnnotationQueueAssignmentResponse as CreateAnnotationQueueAssignmentResponse, type index$z_CreateAnnotationQueueItemRequest as CreateAnnotationQueueItemRequest, type index$z_CreateAnnotationQueueRequest as CreateAnnotationQueueRequest, type index$z_DeleteAnnotationQueueAssignmentResponse as DeleteAnnotationQueueAssignmentResponse, type index$z_DeleteAnnotationQueueItemResponse as DeleteAnnotationQueueItemResponse, type index$z_GetAnnotationQueueItemsRequest as GetAnnotationQueueItemsRequest, type index$z_GetAnnotationQueuesRequest as GetAnnotationQueuesRequest, type index$z_PaginatedAnnotationQueueItems as PaginatedAnnotationQueueItems, type index$z_PaginatedAnnotationQueues as PaginatedAnnotationQueues, type index$z_UpdateAnnotationQueueItemRequest as UpdateAnnotationQueueItemRequest };
}
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
type BlobStorageExportFrequency = "every_20_minutes" | "hourly" | "daily" | "weekly";
declare const BlobStorageExportFrequency: {
    readonly Every20Minutes: "every_20_minutes";
...
declare const BlobStorageExportSource: {
    readonly LegacyTracesObservations: "LEGACY_TRACES_OBSERVATIONS";
    readonly ObservationsV2: "OBSERVATIONS_V2";
    readonly LegacyTracesAndEnrichedObservations: "LEGACY_TRACES_AND_ENRICHED_OBSERVATIONS";
};
 ...
 */
type BlobStorageExportFieldGroup = "core" | "basic" | "time" | "io" | "metadata" | "model" | "usage" | "prompt" | "metrics" | "tools" | "trace_context";
declare const BlobStorageExportFieldGroup: {
    readonly Core: "core";
    ...
    readonly TraceContext: "trace_context";
};
...
interface BlobStorageIntegrationResponse {
    ...
    exportFieldGroups: BlobStorageExportFieldGroup[] | null;
...
declare const index$y_BlobStorageExportFieldGroup: typeof BlobStorageExportFieldGroup;
declare const index$y_BlobStorageExportFrequency: typeof BlobStorageExportFrequency;
declare const index$y_BlobStorageExportMode: typeof BlobStorageExportMode;
declare const index$y_BlobStorageExportSource: typeof BlobStorageExportSource;
type index$y_BlobStorageIntegrationDeletionResponse = BlobStorageIntegrationDeletionResponse;
declare const index$y_BlobStorageIntegrationFileType: typeof BlobStorageIntegrationFileType;
type index$y_BlobStorageIntegrationResponse = BlobStorageIntegrationResponse;
type index$y_BlobStorageIntegrationStatusResponse = BlobStorageIntegrationStatusResponse;
declare const index$y_BlobStorageIntegrationType: typeof BlobStorageIntegrationType;
type index$y_BlobStorageIntegrationsResponse = BlobStorageIntegrationsResponse;
declare const index$y_BlobStorageSyncStatus: typeof BlobStorageSyncStatus;
type index$y_CreateBlobStorageIntegrationRequest = CreateBlobStorageIntegrationRequest;
declare namespace index$y {
  export { index$y_BlobStorageExportFieldGroup as BlobStorageExportFieldGroup, index$y_BlobStorageExportFrequency as BlobStorageExportFrequency, index$y_BlobStorageExportMode as BlobStorageExportMode, index$y_BlobStorageExportSource as BlobStorageExportSource, type index$y_BlobStorageIntegrationDeletionResponse as BlobStorageIntegrationDeletionResponse, index$y_BlobStorageIntegrationFileType as BlobStorageIntegrationFileType, type index$y_BlobStorageIntegrationResponse as BlobStorageIntegrationResponse, type index$y_BlobStorageIntegrationStatusResponse as BlobStorageIntegrationStatusResponse, index$y_BlobStorageIntegrationType as BlobStorageIntegrationType, type index$y_BlobStorageIntegrationsResponse as BlobStorageIntegrationsResponse, index$y_BlobStorageSyncStatus as BlobStorageSyncStatus, type index$y_CreateBlobStorageIntegrationRequest as CreateBlobStorageIntegrationRequest };
}
...
type index$x_CreateCommentRequest = CreateCommentRequest;
type index$x_CreateCommentResponse = CreateCommentResponse;
type index$x_GetCommentsRequest = GetCommentsRequest;
type index$x_GetCommentsResponse = GetCommentsResponse;
declare namespace index$x {
  export type { index$x_CreateCommentRequest as CreateCommentRequest, index$x_CreateCommentResponse as CreateCommentResponse, index$x_GetCommentsRequest as GetCommentsRequest, index$x_GetCommentsResponse as GetCommentsResponse };
}
...
declare class UnauthorizedError$1 extends LangfuseAPIError {
    constructor(body?: unknown, rawResponse?: RawResponse);
}
...
declare class AccessDeniedError$1 extends LangfuseAPIError {
    constructor(body?: unknown, rawResponse?: RawResponse);
}
...
declare class NotFoundError$1 extends LangfuseAPIError {
    constructor(body?: unknown, rawResponse?: RawResponse);
}
...
declare class MethodNotAllowedError$1 extends LangfuseAPIError {
    constructor(body?: unknown, rawResponse?: RawResponse);
}

type index$w_BaseScore = BaseScore;
type index$w_BaseScoreV1 = BaseScoreV1;
type index$w_BooleanScore = BooleanScore;
type index$w_BooleanScoreV1 = BooleanScoreV1;
type index$w_CategoricalScore = CategoricalScore;
type index$w_CategoricalScoreV1 = CategoricalScoreV1;
type index$w_Comment = Comment;
declare const index$w_CommentObjectType: typeof CommentObjectType;
type index$w_ConfigCategory = ConfigCategory;
type index$w_CorrectionScore = CorrectionScore;
type index$w_CreateScoreValue = CreateScoreValue;
type index$w_Dataset = Dataset;
type index$w_DatasetItem = DatasetItem;
type index$w_DatasetRun = DatasetRun;
type index$w_DatasetRunItem = DatasetRunItem;
type index$w_DatasetRunWithItems = DatasetRunWithItems;
declare const index$w_DatasetStatus: typeof DatasetStatus;
type index$w_MapValue = MapValue;
type index$w_Model = Model;
type index$w_ModelPrice = ModelPrice;
declare const index$w_ModelUsageUnit: typeof ModelUsageUnit;
type index$w_NumericScore = NumericScore;
type index$w_NumericScoreV1 = NumericScoreV1;
type index$w_Observation = Observation;
declare const index$w_ObservationLevel: typeof ObservationLevel;
type index$w_ObservationV2 = ObservationV2;
type index$w_ObservationsView = ObservationsView;
type index$w_PricingTier = PricingTier;
type index$w_PricingTierCondition = PricingTierCondition;
type index$w_PricingTierInput = PricingTierInput;
declare const index$w_PricingTierOperator: typeof PricingTierOperator;
declare const index$w_Score: typeof Score;
type index$w_ScoreConfig = ScoreConfig;
declare const index$w_ScoreConfigDataType: typeof ScoreConfigDataType;
declare const index$w_ScoreDataType: typeof ScoreDataType;
declare const index$w_ScoreSource: typeof ScoreSource;
type index$w_Session = Session;
type index$w_SessionWithTraces = SessionWithTraces;
type index$w_TextScore = TextScore;
type index$w_TextScoreV1 = TextScoreV1;
type index$w_TraceWithDetails = TraceWithDetails;
type index$w_TraceWithFullDetails = TraceWithFullDetails;
type index$w_Usage = Usage;
declare namespace index$w {
  export { AccessDeniedError$1 as AccessDeniedError, type index$w_BaseScore as BaseScore, type index$w_BaseScoreV1 as BaseScoreV1, type index$w_BooleanScore as BooleanScore, type index$w_BooleanScoreV1 as BooleanScoreV1, type index$w_CategoricalScore as CategoricalScore, type index$w_CategoricalScoreV1 as CategoricalScoreV1, type index$w_Comment as Comment, index$w_CommentObjectType as CommentObjectType, type index$w_ConfigCategory as ConfigCategory, type index$w_CorrectionScore as CorrectionScore, type index$w_CreateScoreValue as CreateScoreValue, type index$w_Dataset as Dataset, type index$w_DatasetItem as DatasetItem, type index$w_DatasetRun as DatasetRun, type index$w_DatasetRunItem as DatasetRunItem, type index$w_DatasetRunWithItems as DatasetRunWithItems, index$w_DatasetStatus as DatasetStatus, Error$1 as Error, type index$w_MapValue as MapValue, MethodNotAllowedError$1 as MethodNotAllowedError, type index$w_Model as Model, type index$w_ModelPrice as ModelPrice, index$w_ModelUsageUnit as ModelUsageUnit, NotFoundError$1 as NotFoundError, type index$w_NumericScore as NumericScore, type index$w_NumericScoreV1 as NumericScoreV1, type index$w_Observation as Observation, index$w_ObservationLevel as ObservationLevel, type index$w_ObservationV2 as ObservationV2, type index$w_ObservationsView as ObservationsView, type index$w_PricingTier as PricingTier, type index$w_PricingTierCondition as PricingTierCondition, type index$w_PricingTierInput as PricingTierInput, index$w_PricingTierOperator as PricingTierOperator, index$w_Score as Score, type index$w_ScoreConfig as ScoreConfig, index$w_ScoreConfigDataType as ScoreConfigDataType, index$w_ScoreDataType as ScoreDataType, index$w_ScoreSource as ScoreSource, ScoreV1$1 as ScoreV1, type index$w_Session as Session, type index$w_SessionWithTraces as SessionWithTraces, type index$w_TextScore as TextScore, type index$w_TextScoreV1 as TextScoreV1, type Trace$1 as Trace, type index$w_TraceWithDetails as TraceWithDetails, type index$w_TraceWithFullDetails as TraceWithFullDetails, UnauthorizedError$1 as UnauthorizedError, type index$w_Usage as Usage };
}
...
type index$v_CreateDatasetItemRequest = CreateDatasetItemRequest;
type index$v_DeleteDatasetItemResponse = DeleteDatasetItemResponse;
type index$v_GetDatasetItemsRequest = GetDatasetItemsRequest;
type index$v_PaginatedDatasetItems = PaginatedDatasetItems;
declare namespace index$v {
  export type { index$v_CreateDatasetItemRequest as CreateDatasetItemRequest, index$v_DeleteDatasetItemResponse as DeleteDatasetItemResponse, index$v_GetDatasetItemsRequest as GetDatasetItemsRequest, index$v_PaginatedDatasetItems as PaginatedDatasetItems };
}
...
type index$u_CreateDatasetRunItemRequest = CreateDatasetRunItemRequest;
type index$u_ListDatasetRunItemsRequest = ListDatasetRunItemsRequest;
type index$u_PaginatedDatasetRunItems = PaginatedDatasetRunItems;
declare namespace index$u {
  export type { index$u_CreateDatasetRunItemRequest as CreateDatasetRunItemRequest, index$u_ListDatasetRunItemsRequest as ListDatasetRunItemsRequest, index$u_PaginatedDatasetRunItems as PaginatedDatasetRunItems };
}
...
type index$t_CreateDatasetRequest = CreateDatasetRequest;
type index$t_DeleteDatasetRunResponse = DeleteDatasetRunResponse;
type index$t_GetDatasetRunsRequest = GetDatasetRunsRequest;
type index$t_GetDatasetsRequest = GetDatasetsRequest;
type index$t_PaginatedDatasetRuns = PaginatedDatasetRuns;
type index$t_PaginatedDatasets = PaginatedDatasets;
declare namespace index$t {
  export type { index$t_CreateDatasetRequest as CreateDatasetRequest, index$t_DeleteDatasetRunResponse as DeleteDatasetRunResponse, index$t_GetDatasetRunsRequest as GetDatasetRunsRequest, index$t_GetDatasetsRequest as GetDatasetsRequest, index$t_PaginatedDatasetRuns as PaginatedDatasetRuns, index$t_PaginatedDatasets as PaginatedDatasets };
}
...
type index$s_HealthResponse = HealthResponse;
type index$s_ServiceUnavailableError = ServiceUnavailableError;
declare const index$s_ServiceUnavailableError: typeof ServiceUnavailableError;
declare namespace index$s {
  export { type index$s_HealthResponse as HealthResponse, index$s_ServiceUnavailableError as ServiceUnavailableError };
}
...
type index$r_BaseEvent = BaseEvent;
type index$r_CreateEventBody = CreateEventBody;
type index$r_CreateEventEvent = CreateEventEvent;
type index$r_CreateGenerationBody = CreateGenerationBody;
type index$r_CreateGenerationEvent = CreateGenerationEvent;
type index$r_CreateObservationEvent = CreateObservationEvent;
type index$r_CreateSpanBody = CreateSpanBody;
type index$r_CreateSpanEvent = CreateSpanEvent;
type index$r_IngestionError = IngestionError;
declare const index$r_IngestionEvent: typeof IngestionEvent;
type index$r_IngestionRequest = IngestionRequest;
type index$r_IngestionResponse = IngestionResponse;
type index$r_IngestionSuccess = IngestionSuccess;
type index$r_IngestionUsage = IngestionUsage;
type index$r_ObservationBody = ObservationBody;
declare const index$r_ObservationType: typeof ObservationType;
type index$r_OpenAiCompletionUsageSchema = OpenAiCompletionUsageSchema;
type index$r_OpenAiResponseUsageSchema = OpenAiResponseUsageSchema;
type index$r_OpenAiUsage = OpenAiUsage;
type index$r_OptionalObservationBody = OptionalObservationBody;
type index$r_ScoreBody = ScoreBody;
type index$r_ScoreEvent = ScoreEvent;
type index$r_SdkLogBody = SdkLogBody;
type index$r_SdkLogEvent = SdkLogEvent;
type index$r_TraceBody = TraceBody;
type index$r_TraceEvent = TraceEvent;
type index$r_UpdateEventBody = UpdateEventBody;
type index$r_UpdateGenerationBody = UpdateGenerationBody;
type index$r_UpdateGenerationEvent = UpdateGenerationEvent;
type index$r_UpdateObservationEvent = UpdateObservationEvent;
type index$r_UpdateSpanBody = UpdateSpanBody;
type index$r_UpdateSpanEvent = UpdateSpanEvent;
type index$r_UsageDetails = UsageDetails;
declare namespace index$r {
  export { type index$r_BaseEvent as BaseEvent, type index$r_CreateEventBody as CreateEventBody, type index$r_CreateEventEvent as CreateEventEvent, type index$r_CreateGenerationBody as CreateGenerationBody, type index$r_CreateGenerationEvent as CreateGenerationEvent, type index$r_CreateObservationEvent as CreateObservationEvent, type index$r_CreateSpanBody as CreateSpanBody, type index$r_CreateSpanEvent as CreateSpanEvent, type index$r_IngestionError as IngestionError, index$r_IngestionEvent as IngestionEvent, type index$r_IngestionRequest as IngestionRequest, type index$r_IngestionResponse as IngestionResponse, type index$r_IngestionSuccess as IngestionSuccess, type index$r_IngestionUsage as IngestionUsage, type index$r_ObservationBody as ObservationBody, index$r_ObservationType as ObservationType, type index$r_OpenAiCompletionUsageSchema as OpenAiCompletionUsageSchema, type index$r_OpenAiResponseUsageSchema as OpenAiResponseUsageSchema, type index$r_OpenAiUsage as OpenAiUsage, type index$r_OptionalObservationBody as OptionalObservationBody, type index$r_ScoreBody as ScoreBody, type index$r_ScoreEvent as ScoreEvent, type index$r_SdkLogBody as SdkLogBody, type index$r_SdkLogEvent as SdkLogEvent, type index$r_TraceBody as TraceBody, type index$r_TraceEvent as TraceEvent, type index$r_UpdateEventBody as UpdateEventBody, type index$r_UpdateGenerationBody as UpdateGenerationBody, type index$r_UpdateGenerationEvent as UpdateGenerationEvent, type index$r_UpdateObservationEvent as UpdateObservationEvent, type index$r_UpdateSpanBody as UpdateSpanBody, type index$r_UpdateSpanEvent as UpdateSpanEvent, type index$r_UsageDetails as UsageDetails };
}
...
type index$q_GetMetricsRequest = GetMetricsRequest;
type index$q_MetricsResponse = MetricsResponse;
declare namespace index$q {
  export type { index$q_GetMetricsRequest as GetMetricsRequest, index$q_MetricsResponse as MetricsResponse };
}
...
type index$p_GetObservationsRequest = GetObservationsRequest;
type index$p_ObservationsViews = ObservationsViews;
declare namespace index$p {
  export type { index$p_GetObservationsRequest as GetObservationsRequest, Observations$1 as Observations, index$p_ObservationsViews as ObservationsViews };
}
 ...
 */
type CreateScoreSource = "API" | "ANNOTATION";
declare const CreateScoreSource: {
    readonly Api: "API";
    readonly Annotation: "ANNOTATION";
};
...
type index$o_CreateScoreRequest = CreateScoreRequest;
type index$o_CreateScoreResponse = CreateScoreResponse;
declare const index$o_CreateScoreSource: typeof CreateScoreSource;
declare namespace index$o {
  export { type index$o_CreateScoreRequest as CreateScoreRequest, type index$o_CreateScoreResponse as CreateScoreResponse, index$o_CreateScoreSource as CreateScoreSource };
}

type index$n_CreateScoreRequest = CreateScoreRequest;
type index$n_CreateScoreResponse = CreateScoreResponse;
declare const index$n_CreateScoreSource: typeof CreateScoreSource;
type index$n_GetMetricsRequest = GetMetricsRequest;
type index$n_GetObservationsRequest = GetObservationsRequest;
type index$n_MetricsResponse = MetricsResponse;
type index$n_ObservationsViews = ObservationsViews;
declare namespace index$n {
  export { type index$n_CreateScoreRequest as CreateScoreRequest, type index$n_CreateScoreResponse as CreateScoreResponse, index$n_CreateScoreSource as CreateScoreSource, type index$n_GetMetricsRequest as GetMetricsRequest, type index$n_GetObservationsRequest as GetObservationsRequest, type index$n_MetricsResponse as MetricsResponse, type Observations$1 as Observations, type index$n_ObservationsViews as ObservationsViews, index$q as metricsV1, index$p as observationsV1, index$o as scoreV1 };
}
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
interface DeleteLlmConnectionResponse {
    message: string;
}
...
type index$m_DeleteLlmConnectionResponse = DeleteLlmConnectionResponse;
type index$m_GetLlmConnectionsRequest = GetLlmConnectionsRequest;
declare const index$m_LlmAdapter: typeof LlmAdapter;
type index$m_LlmConnection = LlmConnection;
type index$m_PaginatedLlmConnections = PaginatedLlmConnections;
type index$m_UpsertLlmConnectionRequest = UpsertLlmConnectionRequest;
declare namespace index$m {
  export { type index$m_DeleteLlmConnectionResponse as DeleteLlmConnectionResponse, type index$m_GetLlmConnectionsRequest as GetLlmConnectionsRequest, index$m_LlmAdapter as LlmAdapter, type index$m_LlmConnection as LlmConnection, type index$m_PaginatedLlmConnections as PaginatedLlmConnections, type index$m_UpsertLlmConnectionRequest as UpsertLlmConnectionRequest };
}
...
type index$l_GetMediaResponse = GetMediaResponse;
type index$l_GetMediaUploadUrlRequest = GetMediaUploadUrlRequest;
type index$l_GetMediaUploadUrlResponse = GetMediaUploadUrlResponse;
declare const index$l_MediaContentType: typeof MediaContentType;
type index$l_PatchMediaBody = PatchMediaBody;
declare namespace index$l {
  export { type index$l_GetMediaResponse as GetMediaResponse, type index$l_GetMediaUploadUrlRequest as GetMediaUploadUrlRequest, type index$l_GetMediaUploadUrlResponse as GetMediaUploadUrlResponse, index$l_MediaContentType as MediaContentType, type index$l_PatchMediaBody as PatchMediaBody };
}
...
type index$k_GetMetricsV2Request = GetMetricsV2Request;
type index$k_MetricsV2Response = MetricsV2Response;
declare namespace index$k {
  export type { index$k_GetMetricsV2Request as GetMetricsV2Request, index$k_MetricsV2Response as MetricsV2Response };
}
...
type index$j_CreateModelRequest = CreateModelRequest;
type index$j_GetModelsRequest = GetModelsRequest;
type index$j_PaginatedModels = PaginatedModels;
declare namespace index$j {
  export type { index$j_CreateModelRequest as CreateModelRequest, index$j_GetModelsRequest as GetModelsRequest, index$j_PaginatedModels as PaginatedModels };
}
...
type index$i_GetObservationsV2Request = GetObservationsV2Request;
type index$i_ObservationsV2Meta = ObservationsV2Meta;
type index$i_ObservationsV2Response = ObservationsV2Response;
declare namespace index$i {
  export type { index$i_GetObservationsV2Request as GetObservationsV2Request, index$i_ObservationsV2Meta as ObservationsV2Meta, index$i_ObservationsV2Response as ObservationsV2Response };
}
...
type index$h_OtelAttribute = OtelAttribute;
type index$h_OtelAttributeValue = OtelAttributeValue;
type index$h_OtelResource = OtelResource;
type index$h_OtelResourceSpan = OtelResourceSpan;
type index$h_OtelScope = OtelScope;
type index$h_OtelScopeSpan = OtelScopeSpan;
type index$h_OtelSpan = OtelSpan;
type index$h_OtelTraceRequest = OtelTraceRequest;
type index$h_OtelTraceResponse = OtelTraceResponse;
declare namespace index$h {
  export type { index$h_OtelAttribute as OtelAttribute, index$h_OtelAttributeValue as OtelAttributeValue, index$h_OtelResource as OtelResource, index$h_OtelResourceSpan as OtelResourceSpan, index$h_OtelScope as OtelScope, index$h_OtelScopeSpan as OtelScopeSpan, index$h_OtelSpan as OtelSpan, index$h_OtelTraceRequest as OtelTraceRequest, index$h_OtelTraceResponse as OtelTraceResponse };
}
...
type index$g_DeleteMembershipRequest = DeleteMembershipRequest;
type index$g_MembershipDeletionResponse = MembershipDeletionResponse;
type index$g_MembershipRequest = MembershipRequest;
type index$g_MembershipResponse = MembershipResponse;
declare const index$g_MembershipRole: typeof MembershipRole;
type index$g_MembershipsResponse = MembershipsResponse;
type index$g_OrganizationApiKey = OrganizationApiKey;
type index$g_OrganizationApiKeysResponse = OrganizationApiKeysResponse;
type index$g_OrganizationProject = OrganizationProject;
type index$g_OrganizationProjectsResponse = OrganizationProjectsResponse;
declare namespace index$g {
  export { type index$g_DeleteMembershipRequest as DeleteMembershipRequest, type index$g_MembershipDeletionResponse as MembershipDeletionResponse, type index$g_MembershipRequest as MembershipRequest, type index$g_MembershipResponse as MembershipResponse, index$g_MembershipRole as MembershipRole, type index$g_MembershipsResponse as MembershipsResponse, type index$g_OrganizationApiKey as OrganizationApiKey, type index$g_OrganizationApiKeysResponse as OrganizationApiKeysResponse, type index$g_OrganizationProject as OrganizationProject, type index$g_OrganizationProjectsResponse as OrganizationProjectsResponse };
}
...
type index$f_ApiKeyDeletionResponse = ApiKeyDeletionResponse;
type index$f_ApiKeyList = ApiKeyList;
type index$f_ApiKeyResponse = ApiKeyResponse;
type index$f_ApiKeySummary = ApiKeySummary;
type index$f_CreateApiKeyRequest = CreateApiKeyRequest;
type index$f_CreateProjectRequest = CreateProjectRequest;
type index$f_Organization = Organization;
type index$f_Project = Project;
type index$f_ProjectDeletionResponse = ProjectDeletionResponse;
type index$f_UpdateProjectRequest = UpdateProjectRequest;
declare namespace index$f {
  export type { index$f_ApiKeyDeletionResponse as ApiKeyDeletionResponse, index$f_ApiKeyList as ApiKeyList, index$f_ApiKeyResponse as ApiKeyResponse, index$f_ApiKeySummary as ApiKeySummary, index$f_CreateApiKeyRequest as CreateApiKeyRequest, index$f_CreateProjectRequest as CreateProjectRequest, index$f_Organization as Organization, index$f_Project as Project, index$f_ProjectDeletionResponse as ProjectDeletionResponse, Projects$1 as Projects, index$f_UpdateProjectRequest as UpdateProjectRequest };
}
...
type index$e_BasePrompt = BasePrompt;
type index$e_ChatMessage = ChatMessage;
declare const index$e_ChatMessageType: typeof ChatMessageType;
type index$e_ChatMessageWithPlaceholders = ChatMessageWithPlaceholders;
type index$e_ChatPrompt = ChatPrompt;
type index$e_CreateChatPromptRequest = CreateChatPromptRequest;
declare const index$e_CreateChatPromptType: typeof CreateChatPromptType;
type index$e_CreatePromptRequest = CreatePromptRequest;
type index$e_CreateTextPromptRequest = CreateTextPromptRequest;
declare const index$e_CreateTextPromptType: typeof CreateTextPromptType;
type index$e_DeletePromptRequest = DeletePromptRequest;
type index$e_GetPromptRequest = GetPromptRequest;
type index$e_ListPromptsMetaRequest = ListPromptsMetaRequest;
type index$e_PlaceholderMessage = PlaceholderMessage;
declare const index$e_PlaceholderMessageType: typeof PlaceholderMessageType;
declare const index$e_Prompt: typeof Prompt;
type index$e_PromptMeta = PromptMeta;
type index$e_PromptMetaListResponse = PromptMetaListResponse;
declare const index$e_PromptType: typeof PromptType;
type index$e_TextPrompt = TextPrompt;
declare namespace index$e {
  export { type index$e_BasePrompt as BasePrompt, type index$e_ChatMessage as ChatMessage, index$e_ChatMessageType as ChatMessageType, type index$e_ChatMessageWithPlaceholders as ChatMessageWithPlaceholders, type index$e_ChatPrompt as ChatPrompt, type index$e_CreateChatPromptRequest as CreateChatPromptRequest, index$e_CreateChatPromptType as CreateChatPromptType, type index$e_CreatePromptRequest as CreatePromptRequest, type index$e_CreateTextPromptRequest as CreateTextPromptRequest, index$e_CreateTextPromptType as CreateTextPromptType, type index$e_DeletePromptRequest as DeletePromptRequest, type index$e_GetPromptRequest as GetPromptRequest, type index$e_ListPromptsMetaRequest as ListPromptsMetaRequest, type index$e_PlaceholderMessage as PlaceholderMessage, index$e_PlaceholderMessageType as PlaceholderMessageType, index$e_Prompt as Prompt, type index$e_PromptMeta as PromptMeta, type index$e_PromptMetaListResponse as PromptMetaListResponse, index$e_PromptType as PromptType, type index$e_TextPrompt as TextPrompt };
}
...
type index$d_AuthenticationScheme = AuthenticationScheme;
type index$d_BulkConfig = BulkConfig;
type index$d_CreateUserRequest = CreateUserRequest;
type index$d_EmptyResponse = EmptyResponse;
type index$d_FilterConfig = FilterConfig;
type index$d_ListUsersRequest = ListUsersRequest;
type index$d_ResourceMeta = ResourceMeta;
type index$d_ResourceType = ResourceType;
type index$d_ResourceTypesResponse = ResourceTypesResponse;
type index$d_SchemaExtension = SchemaExtension;
type index$d_SchemaResource = SchemaResource;
type index$d_SchemasResponse = SchemasResponse;
type index$d_ScimEmail = ScimEmail;
type index$d_ScimFeatureSupport = ScimFeatureSupport;
type index$d_ScimName = ScimName;
type index$d_ScimUser = ScimUser;
type index$d_ScimUsersListResponse = ScimUsersListResponse;
type index$d_ServiceProviderConfig = ServiceProviderConfig;
type index$d_UserMeta = UserMeta;
declare namespace index$d {
  export type { index$d_AuthenticationScheme as AuthenticationScheme, index$d_BulkConfig as BulkConfig, index$d_CreateUserRequest as CreateUserRequest, index$d_EmptyResponse as EmptyResponse, index$d_FilterConfig as FilterConfig, index$d_ListUsersRequest as ListUsersRequest, index$d_ResourceMeta as ResourceMeta, index$d_ResourceType as ResourceType, index$d_ResourceTypesResponse as ResourceTypesResponse, index$d_SchemaExtension as SchemaExtension, index$d_SchemaResource as SchemaResource, index$d_SchemasResponse as SchemasResponse, index$d_ScimEmail as ScimEmail, index$d_ScimFeatureSupport as ScimFeatureSupport, index$d_ScimName as ScimName, index$d_ScimUser as ScimUser, index$d_ScimUsersListResponse as ScimUsersListResponse, index$d_ServiceProviderConfig as ServiceProviderConfig, index$d_UserMeta as UserMeta };
}
...
type index$c_CreateScoreConfigRequest = CreateScoreConfigRequest;
type index$c_GetScoreConfigsRequest = GetScoreConfigsRequest;
type index$c_UpdateScoreConfigRequest = UpdateScoreConfigRequest;
declare namespace index$c {
  export type { index$c_CreateScoreConfigRequest as CreateScoreConfigRequest, index$c_GetScoreConfigsRequest as GetScoreConfigsRequest, ScoreConfigs$1 as ScoreConfigs, index$c_UpdateScoreConfigRequest as UpdateScoreConfigRequest };
}

/**
 * This file was auto-generated by Fern from our API Definition.
 */
interface ScoreSubjectTraceV3 {
    /** The trace ID. */
    id: string;
}
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
interface ScoreSubjectSessionV3 {
    /** The session ID. */
    id: string;
}
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
interface ScoreSubjectExperimentV3 {
 ...
 * Subject is a dataset run (experiment) score. */
 | ScoreSubjectV3.Experiment;
declare namespace ScoreSubjectV3 {
    interface Trace extends ScoreSubjectTraceV3 {
        kind: "trace";
    }
    interface Observation extends ScoreSubjectObservationV3 {
        kind: "observation";
    }
    interface Session extends ScoreSubjectSessionV3 {
        kind: "session";
    }
    interface Experiment extends ScoreSubjectExperimentV3 {
        kind: "experiment";
    }
}
...
interface NumericScoreV3 extends BaseScoreV3 {
    /** The numeric value of the score. */
    value: number;
}
...
interface BooleanScoreV3 extends BaseScoreV3 {
...
interface CategoricalScoreV3 extends BaseScoreV3 {
...
interface TextScoreV3 extends BaseScoreV3 {
...
interface CorrectionScoreV3 extends BaseScoreV3 {
 ...
 * Score with CORRECTION data type. Value is the correction string. */
 | ScoreV3.Correction;
declare namespace ScoreV3 {
    interface Numeric extends NumericScoreV3 {
        dataType: "NUMERIC";
    }
    interface Boolean extends BooleanScoreV3 {
        dataType: "BOOLEAN";
    }
    interface Categorical extends CategoricalScoreV3 {
        dataType: "CATEGORICAL";
    }
    interface Text extends TextScoreV3 {
        dataType: "TEXT";
    }
    interface Correction extends CorrectionScoreV3 {
        dataType: "CORRECTION";
    }
}
...
type index$b_BaseScoreV3 = BaseScoreV3;
type index$b_BooleanScoreV3 = BooleanScoreV3;
type index$b_CategoricalScoreV3 = CategoricalScoreV3;
type index$b_CorrectionScoreV3 = CorrectionScoreV3;
type index$b_GetScoresV3Meta = GetScoresV3Meta;
type index$b_GetScoresV3Request = GetScoresV3Request;
type index$b_GetScoresV3Response = GetScoresV3Response;
type index$b_NumericScoreV3 = NumericScoreV3;
type index$b_ScoreSubjectExperimentV3 = ScoreSubjectExperimentV3;
type index$b_ScoreSubjectObservationV3 = ScoreSubjectObservationV3;
type index$b_ScoreSubjectSessionV3 = ScoreSubjectSessionV3;
type index$b_ScoreSubjectTraceV3 = ScoreSubjectTraceV3;
declare const index$b_ScoreSubjectV3: typeof ScoreSubjectV3;
declare const index$b_ScoreV3: typeof ScoreV3;
type index$b_TextScoreV3 = TextScoreV3;
declare namespace index$b {
  export { type index$b_BaseScoreV3 as BaseScoreV3, type index$b_BooleanScoreV3 as BooleanScoreV3, type index$b_CategoricalScoreV3 as CategoricalScoreV3, type index$b_CorrectionScoreV3 as CorrectionScoreV3, type index$b_GetScoresV3Meta as GetScoresV3Meta, type index$b_GetScoresV3Request as GetScoresV3Request, type index$b_GetScoresV3Response as GetScoresV3Response, type index$b_NumericScoreV3 as NumericScoreV3, type index$b_ScoreSubjectExperimentV3 as ScoreSubjectExperimentV3, type index$b_ScoreSubjectObservationV3 as ScoreSubjectObservationV3, type index$b_ScoreSubjectSessionV3 as ScoreSubjectSessionV3, type index$b_ScoreSubjectTraceV3 as ScoreSubjectTraceV3, index$b_ScoreSubjectV3 as ScoreSubjectV3, index$b_ScoreV3 as ScoreV3, type index$b_TextScoreV3 as TextScoreV3 };
}
...
type index$a_GetScoresRequest = GetScoresRequest;
type index$a_GetScoresResponse = GetScoresResponse;
declare const index$a_GetScoresResponseData: typeof GetScoresResponseData;
type index$a_GetScoresResponseDataBoolean = GetScoresResponseDataBoolean;
type index$a_GetScoresResponseDataCategorical = GetScoresResponseDataCategorical;
type index$a_GetScoresResponseDataCorrection = GetScoresResponseDataCorrection;
type index$a_GetScoresResponseDataNumeric = GetScoresResponseDataNumeric;
type index$a_GetScoresResponseDataText = GetScoresResponseDataText;
type index$a_GetScoresResponseTraceData = GetScoresResponseTraceData;
declare namespace index$a {
  export { type index$a_GetScoresRequest as GetScoresRequest, type index$a_GetScoresResponse as GetScoresResponse, index$a_GetScoresResponseData as GetScoresResponseData, type index$a_GetScoresResponseDataBoolean as GetScoresResponseDataBoolean, type index$a_GetScoresResponseDataCategorical as GetScoresResponseDataCategorical, type index$a_GetScoresResponseDataCorrection as GetScoresResponseDataCorrection, type index$a_GetScoresResponseDataNumeric as GetScoresResponseDataNumeric, type index$a_GetScoresResponseDataText as GetScoresResponseDataText, type index$a_GetScoresResponseTraceData as GetScoresResponseTraceData };
}
...
type index$9_GetSessionsRequest = GetSessionsRequest;
type index$9_PaginatedSessions = PaginatedSessions;
declare namespace index$9 {
  export type { index$9_GetSessionsRequest as GetSessionsRequest, index$9_PaginatedSessions as PaginatedSessions };
}
...
type index$8_DeleteTraceResponse = DeleteTraceResponse;
type index$8_DeleteTracesRequest = DeleteTracesRequest;
type index$8_GetTraceRequest = GetTraceRequest;
type index$8_GetTracesRequest = GetTracesRequest;
type index$8_Sort = Sort;
type index$8_Traces = Traces;
declare namespace index$8 {
  export type { index$8_DeleteTraceResponse as DeleteTraceResponse, index$8_DeleteTracesRequest as DeleteTracesRequest, index$8_GetTraceRequest as GetTraceRequest, index$8_GetTracesRequest as GetTracesRequest, index$8_Sort as Sort, index$8_Traces as Traces };
}
 ...
 */
type EvaluatorType = "llm_as_judge" | "code";
declare const EvaluatorType: {
    readonly LlmAsJudge: "llm_as_judge";
    readonly Code: "code";
};
 ...
 */
type CodeEvaluatorSourceCodeLanguage = "PYTHON" | "TYPESCRIPT";
declare const CodeEvaluatorSourceCodeLanguage: {
 ...
 */
type EvaluatorScope = "project" | "managed";
declare const EvaluatorScope: {
 ...
 */
type EvaluationRuleTarget = "observation" | "experiment";
declare const EvaluationRuleTarget: {
    readonly Observation: "observation";
 ...
 */
type EvaluationRuleStatus = "active" | "inactive" | "paused";
declare const EvaluationRuleStatus: {
    readonly Active: "active";
 ...
 */
type EvaluationRuleMappingSource = "input" | "output" | "metadata" | "expected_output" | "experiment_item_metadata";
declare const EvaluationRuleMappingSource: {
    readonly Input: "input";
    readonly Output: "output";
    readonly Metadata: "metadata";
    readonly ExpectedOutput: "expected_output";
    readonly ExperimentItemMetadata: "experiment_item_metadata";
};
 ...
 */
type EvaluatorOutputDataType = "NUMERIC" | "BOOLEAN" | "CATEGORICAL";
declare const EvaluatorOutputDataType: {
    readonly Numeric: "NUMERIC";
    readonly Boolean: "BOOLEAN";
    readonly Categorical: "CATEGORICAL";
};
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
interface EvaluatorOutputFieldDefinition {
 ...
 *     }
 */
type EvaluatorOutputDefinition = EvaluatorOutputDefinition.Numeric | EvaluatorOutputDefinition.Boolean | EvaluatorOutputDefinition.Categorical;
declare namespace EvaluatorOutputDefinition {
    interface Numeric extends PublicNumericEvaluatorOutputDefinition {
        dataType: "NUMERIC";
    }
    interface Boolean extends PublicBooleanEvaluatorOutputDefinition {
        dataType: "BOOLEAN";
    }
    interface Categorical extends PublicCategoricalEvaluatorOutputDefinition {
        dataType: "CATEGORICAL";
    }
}
...
interface PublicNumericEvaluatorOutputDefinition {
    /** Always `NUMERIC`. */
    dataType: EvaluatorOutputDataType;
...
interface PublicBooleanEvaluatorOutputDefinition {
    /** Always `BOOLEAN`. */
    dataType: EvaluatorOutputDataType;
    reasoning: EvaluatorOutputFieldDefinition;
    score: EvaluatorOutputFieldDefinition;
...
interface PublicCategoricalEvaluatorOutputDefinition {
    /** Always `CATEGORICAL`. */
    dataType: EvaluatorOutputDataType;
    reasoning: EvaluatorOutputFieldDefinition;
 ...
 *     }
 */
type PublicEvaluatorOutputDefinition = PublicEvaluatorOutputDefinition.Numeric | PublicEvaluatorOutputDefinition.Boolean | PublicEvaluatorOutputDefinition.Categorical;
declare namespace PublicEvaluatorOutputDefinition {
    interface Numeric extends PublicNumericEvaluatorOutputDefinition {
        dataType: "NUMERIC";
    }
    interface Boolean extends PublicBooleanEvaluatorOutputDefinition {
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
type EvaluationRuleStringFilterOperator = "=" | "contains" | "does not contain" | "starts with" | "ends with";
declare const EvaluationRuleStringFilterOperator: {
    readonly Equals: "=";
...
declare const EvaluationRuleNumberFilterOperator: {
    readonly Equals: "=";
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
type EvaluationRuleOptionsFilterOperator = "any of" | "none of";
declare const EvaluationRuleOptionsFilterOperator: {
    readonly AnyOf: "any of";
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
type EvaluationRuleArrayOptionsFilterOperator = "any of" | "none of" | "all of";
declare const EvaluationRuleArrayOptionsFilterOperator: {
    readonly AnyOf: "any of";
    readonly NoneOf: "none of";
    readonly AllOf: "all of";
};
...
declare const EvaluationRuleBooleanFilterOperator: {
    readonly Equals: "=";
    readonly NotEquals: "<>";
};
 ...
 * This file was auto-generated by Fern from our API Definition.
 */
type EvaluationRuleNullFilterOperator = "is null" | "is not null";
declare const EvaluationRuleNullFilterOperator: {
...
interface DateTimeEvaluationRuleFilter {
    /** Column to filter on. */
    column: string;
...
interface StringEvaluationRuleFilter {
    /** Column to filter on. */
    column: string;
...
interface NumberEvaluationRuleFilter {
    /** Column to filter on. */
    column: string;
    operator: EvaluationRuleNumberFilterOperator;
    value: number;
...
interface StringOptionsEvaluationRuleFilter {
    /** Column to filter on. */
    column: string;
...
interface ArrayOptionsEvaluationRuleFilter {
    /** Column to filter on. */
    column: string;
...
interface NumberObjectEvaluationRuleFilter {
...
interface CategoryOptionsEvaluationRuleFilter {
    /** Object-valued column to filter on. */
    column: string;
    /** Key inside the object-valued column to filter on. */
    key: string;
...
interface BooleanEvaluationRuleFilter {
    /** Column to filter on. */
    column: string;
...
interface NullEvaluationRuleFilter {
 ...
 *     }
 */
type EvaluationRuleFilter = EvaluationRuleFilter.Datetime | EvaluationRuleFilter.String | EvaluationRuleFilter.Number | EvaluationRuleFilter.StringOptions | EvaluationRuleFilter.CategoryOptions | EvaluationRuleFilter.ArrayOptions | EvaluationRuleFilter.StringObject | EvaluationRuleFilter.NumberObject | EvaluationRuleFilter.Boolean | EvaluationRuleFilter.Null;
declare namespace EvaluationRuleFilter {
    interface Datetime extends DateTimeEvaluationRuleFilter {
        type: "datetime";
    }
    interface String extends StringEvaluationRuleFilter {
        type: "string";
    }
    interface Number extends NumberEvaluationRuleFilter {
        type: "number";
    }
    interface StringOptions extends StringOptionsEvaluationRuleFilter {
        type: "stringOptions";
    }
    interface CategoryOptions extends CategoryOptionsEvaluationRuleFilter {
        type: "categoryOptions";
    }
    interface ArrayOptions extends ArrayOptionsEvaluationRuleFilter {
        type: "arrayOptions";
    }
    interface StringObject extends StringObjectEvaluationRuleFilter {
        type: "stringObject";
    }
    interface NumberObject extends NumberObjectEvaluationRuleFilter {
        type: "numberObject";
    }
    interface Boolean extends BooleanEvaluationRuleFilter {
        type: "boolean";
    }
    interface Null extends NullEvaluationRuleFilter {
        type: "null";
    }
}

type index$7_ArrayOptionsEvaluationRuleFilter = ArrayOptionsEvaluationRuleFilter;
type index$7_BooleanEvaluationRuleFilter = BooleanEvaluationRuleFilter;
type index$7_CategoryOptionsEvaluationRuleFilter = CategoryOptionsEvaluationRuleFilter;
declare const index$7_CodeEvaluatorSourceCodeLanguage: typeof CodeEvaluatorSourceCodeLanguage;
type index$7_DateTimeEvaluationRuleFilter = DateTimeEvaluationRuleFilter;
declare const index$7_EvaluationRuleArrayOptionsFilterOperator: typeof EvaluationRuleArrayOptionsFilterOperator;
declare const index$7_EvaluationRuleBooleanFilterOperator: typeof EvaluationRuleBooleanFilterOperator;
declare const index$7_EvaluationRuleFilter: typeof EvaluationRuleFilter;
type index$7_EvaluationRuleMapping = EvaluationRuleMapping;
declare const index$7_EvaluationRuleMappingSource: typeof EvaluationRuleMappingSource;
declare const index$7_EvaluationRuleNullFilterOperator: typeof EvaluationRuleNullFilterOperator;
declare const index$7_EvaluationRuleNumberFilterOperator: typeof EvaluationRuleNumberFilterOperator;
declare const index$7_EvaluationRuleOptionsFilterOperator: typeof EvaluationRuleOptionsFilterOperator;
declare const index$7_EvaluationRuleStatus: typeof EvaluationRuleStatus;
declare const index$7_EvaluationRuleStringFilterOperator: typeof EvaluationRuleStringFilterOperator;
declare const index$7_EvaluationRuleTarget: typeof EvaluationRuleTarget;
type index$7_EvaluatorModelConfig = EvaluatorModelConfig;
declare const index$7_EvaluatorOutputDataType: typeof EvaluatorOutputDataType;
declare const index$7_EvaluatorOutputDefinition: typeof EvaluatorOutputDefinition;
type index$7_EvaluatorOutputFieldDefinition = EvaluatorOutputFieldDefinition;
declare const index$7_EvaluatorScope: typeof EvaluatorScope;
declare const index$7_EvaluatorType: typeof EvaluatorType;
type index$7_NullEvaluationRuleFilter = NullEvaluationRuleFilter;
type index$7_NumberEvaluationRuleFilter = NumberEvaluationRuleFilter;
type index$7_NumberObjectEvaluationRuleFilter = NumberObjectEvaluationRuleFilter;
type index$7_PublicBooleanEvaluatorOutputDefinition = PublicBooleanEvaluatorOutputDefinition;
type index$7_PublicCategoricalEvaluatorOutputDefinition = PublicCategoricalEvaluatorOutputDefinition;
type index$7_PublicCategoricalEvaluatorOutputScoreDefinition = PublicCategoricalEvaluatorOutputScoreDefinition;
declare const index$7_PublicEvaluatorOutputDefinition: typeof PublicEvaluatorOutputDefinition;
type index$7_PublicNumericEvaluatorOutputDefinition = PublicNumericEvaluatorOutputDefinition;
type index$7_StringEvaluationRuleFilter = StringEvaluationRuleFilter;
type index$7_StringObjectEvaluationRuleFilter = StringObjectEvaluationRuleFilter;
type index$7_StringOptionsEvaluationRuleFilter = StringOptionsEvaluationRuleFilter;
declare namespace index$7 {
  export { type index$7_ArrayOptionsEvaluationRuleFilter as ArrayOptionsEvaluationRuleFilter, type index$7_BooleanEvaluationRuleFilter as BooleanEvaluationRuleFilter, type index$7_CategoryOptionsEvaluationRuleFilter as CategoryOptionsEvaluationRuleFilter, index$7_CodeEvaluatorSourceCodeLanguage as CodeEvaluatorSourceCodeLanguage, type index$7_DateTimeEvaluationRuleFilter as DateTimeEvaluationRuleFilter, index$7_EvaluationRuleArrayOptionsFilterOperator as EvaluationRuleArrayOptionsFilterOperator, index$7_EvaluationRuleBooleanFilterOperator as EvaluationRuleBooleanFilterOperator, index$7_EvaluationRuleFilter as EvaluationRuleFilter, type index$7_EvaluationRuleMapping as EvaluationRuleMapping, index$7_EvaluationRuleMappingSource as EvaluationRuleMappingSource, index$7_EvaluationRuleNullFilterOperator as EvaluationRuleNullFilterOperator, index$7_EvaluationRuleNumberFilterOperator as EvaluationRuleNumberFilterOperator, index$7_EvaluationRuleOptionsFilterOperator as EvaluationRuleOptionsFilterOperator, index$7_EvaluationRuleStatus as EvaluationRuleStatus, index$7_EvaluationRuleStringFilterOperator as EvaluationRuleStringFilterOperator, index$7_EvaluationRuleTarget as EvaluationRuleTarget, type index$7_EvaluatorModelConfig as EvaluatorModelConfig, index$7_EvaluatorOutputDataType as EvaluatorOutputDataType, index$7_EvaluatorOutputDefinition as EvaluatorOutputDefinition, type index$7_EvaluatorOutputFieldDefinition as EvaluatorOutputFieldDefinition, index$7_EvaluatorScope as EvaluatorScope, index$7_EvaluatorType as EvaluatorType, type index$7_NullEvaluationRuleFilter as NullEvaluationRuleFilter, type index$7_NumberEvaluationRuleFilter as NumberEvaluationRuleFilter, type index$7_NumberObjectEvaluationRuleFilter as NumberObjectEvaluationRuleFilter, type index$7_PublicBooleanEvaluatorOutputDefinition as PublicBooleanEvaluatorOutputDefinition, type index$7_PublicCategoricalEvaluatorOutputDefinition as PublicCategoricalEvaluatorOutputDefinition, type index$7_PublicCategoricalEvaluatorOutputScoreDefinition as PublicCategoricalEvaluatorOutputScoreDefinition, index$7_PublicEvaluatorOutputDefinition as PublicEvaluatorOutputDefinition, type index$7_PublicNumericEvaluatorOutputDefinition as PublicNumericEvaluatorOutputDefinition, type index$7_StringEvaluationRuleFilter as StringEvaluationRuleFilter, type index$7_StringObjectEvaluationRuleFilter as StringObjectEvaluationRuleFilter, type index$7_StringOptionsEvaluationRuleFilter as StringOptionsEvaluationRuleFilter };
}
...
declare const PublicApiErrorCode: {
    ...
    readonly InvalidFilterValue: "invalid_filter_value";
    readonly InvalidJsonPath: "invalid_json_path";
    readonly InvalidVariableMapping: "invalid_variable_mapping";
    readonly MissingVariableMapping: "missing_variable_mapping";
    readonly DuplicateVariableMapping: "duplicate_variable_mapping";
    readonly ResourceNotFound: "resource_not_found";
    readonly NameConflict: "name_conflict";
    readonly EvaluatorPreflightFailed: "evaluator_preflight_failed";
    readonly Conflict: "conflict";
    readonly UnprocessableContent: "unprocessable_content";
...
interface PublicApiErrorDetails {
    ...
    issues?: PublicApiValidationIssue[];
...
declare class BadRequestError extends LangfuseAPIError {
    constructor(body: PublicApiError, rawResponse?: RawResponse);
}
...
declare class ConflictError extends LangfuseAPIError {
    constructor(body: PublicApiError, rawResponse?: RawResponse);
}
...
declare class UnprocessableContentError extends LangfuseAPIError {
    constructor(body: PublicApiError, rawResponse?: RawResponse);
}
...
declare class TooManyRequestsError extends LangfuseAPIError {
    constructor(body: PublicApiError, rawResponse?: RawResponse);
}
...
declare class InternalServerError extends LangfuseAPIError {
    constructor(body: PublicApiError, rawResponse?: RawResponse);
}

type index$6_AccessDeniedError = AccessDeniedError;
declare const index$6_AccessDeniedError: typeof AccessDeniedError;
type index$6_BadRequestError = BadRequestError;
declare const index$6_BadRequestError: typeof BadRequestError;
type index$6_ConflictError = ConflictError;
declare const index$6_ConflictError: typeof ConflictError;
type index$6_InternalServerError = InternalServerError;
declare const index$6_InternalServerError: typeof InternalServerError;
type index$6_MethodNotAllowedError = MethodNotAllowedError;
declare const index$6_MethodNotAllowedError: typeof MethodNotAllowedError;
type index$6_NotFoundError = NotFoundError;
declare const index$6_NotFoundError: typeof NotFoundError;
type index$6_PublicApiError = PublicApiError;
declare const index$6_PublicApiErrorCode: typeof PublicApiErrorCode;
type index$6_PublicApiErrorDetails = PublicApiErrorDetails;
type index$6_PublicApiValidationIssue = PublicApiValidationIssue;
type index$6_TooManyRequestsError = TooManyRequestsError;
declare const index$6_TooManyRequestsError: typeof TooManyRequestsError;
type index$6_UnauthorizedError = UnauthorizedError;
declare const index$6_UnauthorizedError: typeof UnauthorizedError;
type index$6_UnprocessableContentError = UnprocessableContentError;
declare const index$6_UnprocessableContentError: typeof UnprocessableContentError;
declare namespace index$6 {
  export { index$6_AccessDeniedError as AccessDeniedError, index$6_BadRequestError as BadRequestError, index$6_ConflictError as ConflictError, index$6_InternalServerError as InternalServerError, index$6_MethodNotAllowedError as MethodNotAllowedError, index$6_NotFoundError as NotFoundError, type index$6_PublicApiError as PublicApiError, index$6_PublicApiErrorCode as PublicApiErrorCode, type index$6_PublicApiErrorDetails as PublicApiErrorDetails, type index$6_PublicApiValidationIssue as PublicApiValidationIssue, index$6_TooManyRequestsError as TooManyRequestsError, index$6_UnauthorizedError as UnauthorizedError, index$6_UnprocessableContentError as UnprocessableContentError };
}
 ...
 */
type CreateEvaluationRuleRequest = CreateLlmAsJudgeEvaluationRuleRequest | CreateCodeEvaluationRuleRequest;
...
interface CreateCodeEvaluationRuleRequest {
     ...
     * Langfuse resolves that family to its latest version before saving the rule.
     */
    evaluator: CodeEvaluationRuleEvaluatorReference;
    /** Target object type to evaluate. */
    target: EvaluationRuleTarget;
    /** Whether the deployment should be active immediately after creation. */
    enabled: boolean;
 ...
 */
interface LlmAsJudgeEvaluationRuleEvaluatorReference {
    /** Evaluator family name. */
    name: string;
    /** Whether the evaluator family is project-owned or Langfuse-managed. */
    scope: EvaluatorScope;
 ...
 */
interface CodeEvaluationRuleEvaluatorReference {
    /** Evaluator family name. */
    name: string;
    /** Whether the evaluator family is project-owned or Langfuse-managed. */
    scope: EvaluatorScope;
...
declare const LlmAsJudgeEvaluatorType: {
    readonly LlmAsJudge: "llm_as_judge";
};
 ...
 *     {}
 */
interface ListEvaluationRulesRequest {
...
type index$5_CodeEvaluationRuleEvaluatorReference = CodeEvaluationRuleEvaluatorReference;
type index$5_CreateCodeEvaluationRuleRequest = CreateCodeEvaluationRuleRequest;
type index$5_CreateEvaluationRuleRequest = CreateEvaluationRuleRequest;
type index$5_CreateLlmAsJudgeEvaluationRuleRequest = CreateLlmAsJudgeEvaluationRuleRequest;
type index$5_DeleteEvaluationRuleResponse = DeleteEvaluationRuleResponse;
type index$5_EvaluationRule = EvaluationRule;
type index$5_EvaluationRuleEvaluator = EvaluationRuleEvaluator;
type index$5_EvaluationRuleEvaluatorReference = EvaluationRuleEvaluatorReference;
type index$5_ListEvaluationRulesRequest = ListEvaluationRulesRequest;
type index$5_LlmAsJudgeEvaluationRuleEvaluatorReference = LlmAsJudgeEvaluationRuleEvaluatorReference;
declare const index$5_LlmAsJudgeEvaluatorType: typeof LlmAsJudgeEvaluatorType;
type index$5_UpdateEvaluationRuleRequest = UpdateEvaluationRuleRequest;
declare namespace index$5 {
  export { type index$5_CodeEvaluationRuleEvaluatorReference as CodeEvaluationRuleEvaluatorReference, type index$5_CreateCodeEvaluationRuleRequest as CreateCodeEvaluationRuleRequest, type index$5_CreateEvaluationRuleRequest as CreateEvaluationRuleRequest, type index$5_CreateLlmAsJudgeEvaluationRuleRequest as CreateLlmAsJudgeEvaluationRuleRequest, type index$5_DeleteEvaluationRuleResponse as DeleteEvaluationRuleResponse, type index$5_EvaluationRule as EvaluationRule, type index$5_EvaluationRuleEvaluator as EvaluationRuleEvaluator, type index$5_EvaluationRuleEvaluatorReference as EvaluationRuleEvaluatorReference, type EvaluationRules$1 as EvaluationRules, type index$5_ListEvaluationRulesRequest as ListEvaluationRulesRequest, type index$5_LlmAsJudgeEvaluationRuleEvaluatorReference as LlmAsJudgeEvaluationRuleEvaluatorReference, index$5_LlmAsJudgeEvaluatorType as LlmAsJudgeEvaluatorType, type index$5_UpdateEvaluationRuleRequest as UpdateEvaluationRuleRequest };
}
 ...
 */
type Evaluator = Evaluator.LlmAsJudge | Evaluator.Code;
declare namespace Evaluator {
    interface LlmAsJudge extends LlmAsJudgeEvaluator {
        type: "llm_as_judge";
    }
    interface Code extends CodeEvaluator {
        type: "code";
    }
}
...
interface LlmAsJudgeEvaluator extends EvaluatorBase {
...
interface CodeEvaluator extends EvaluatorBase {
 ...
 */
type CreateEvaluatorRequest = CreateEvaluatorRequest.LlmAsJudge | CreateEvaluatorRequest.Code;
declare namespace CreateEvaluatorRequest {
    interface LlmAsJudge extends CreateLlmAsJudgeEvaluatorRequest {
        type: "llm_as_judge";
    }
    interface Code extends CreateCodeEvaluatorRequest {
        type: "code";
    }
}
...
interface CreateLlmAsJudgeEvaluatorRequest {
...
interface CreateCodeEvaluatorRequest {
    /** Evaluator name within the authenticated project. */
    name: string;
 ...
 *     {}
 */
interface ListEvaluatorsRequest {
    /** 1-based page number. Defaults to `1`. */
    page?: number;
    /** Maximum number of items per page. Defaults to `50`. */
    limit?: number;
...
type index$4_CodeEvaluator = CodeEvaluator;
type index$4_CreateCodeEvaluatorRequest = CreateCodeEvaluatorRequest;
declare const index$4_CreateEvaluatorRequest: typeof CreateEvaluatorRequest;
type index$4_CreateLlmAsJudgeEvaluatorRequest = CreateLlmAsJudgeEvaluatorRequest;
type index$4_DeleteEvaluatorResponse = DeleteEvaluatorResponse;
declare const index$4_Evaluator: typeof Evaluator;
type index$4_EvaluatorBase = EvaluatorBase;
type index$4_ListEvaluatorsRequest = ListEvaluatorsRequest;
type index$4_LlmAsJudgeEvaluator = LlmAsJudgeEvaluator;
declare namespace index$4 {
  export { type index$4_CodeEvaluator as CodeEvaluator, type index$4_CreateCodeEvaluatorRequest as CreateCodeEvaluatorRequest, index$4_CreateEvaluatorRequest as CreateEvaluatorRequest, type index$4_CreateLlmAsJudgeEvaluatorRequest as CreateLlmAsJudgeEvaluatorRequest, type index$4_DeleteEvaluatorResponse as DeleteEvaluatorResponse, index$4_Evaluator as Evaluator, type index$4_EvaluatorBase as EvaluatorBase, type Evaluators$1 as Evaluators, type index$4_ListEvaluatorsRequest as ListEvaluatorsRequest, type index$4_LlmAsJudgeEvaluator as LlmAsJudgeEvaluator };
}

type index$3_AccessDeniedError = AccessDeniedError;
declare const index$3_AccessDeniedError: typeof AccessDeniedError;
type index$3_ArrayOptionsEvaluationRuleFilter = ArrayOptionsEvaluationRuleFilter;
type index$3_BadRequestError = BadRequestError;
declare const index$3_BadRequestError: typeof BadRequestError;
type index$3_BooleanEvaluationRuleFilter = BooleanEvaluationRuleFilter;
type index$3_CategoryOptionsEvaluationRuleFilter = CategoryOptionsEvaluationRuleFilter;
type index$3_CodeEvaluationRuleEvaluatorReference = CodeEvaluationRuleEvaluatorReference;
type index$3_CodeEvaluator = CodeEvaluator;
declare const index$3_CodeEvaluatorSourceCodeLanguage: typeof CodeEvaluatorSourceCodeLanguage;
type index$3_ConflictError = ConflictError;
declare const index$3_ConflictError: typeof ConflictError;
type index$3_CreateCodeEvaluationRuleRequest = CreateCodeEvaluationRuleRequest;
type index$3_CreateCodeEvaluatorRequest = CreateCodeEvaluatorRequest;
type index$3_CreateEvaluationRuleRequest = CreateEvaluationRuleRequest;
declare const index$3_CreateEvaluatorRequest: typeof CreateEvaluatorRequest;
type index$3_CreateLlmAsJudgeEvaluationRuleRequest = CreateLlmAsJudgeEvaluationRuleRequest;
type index$3_CreateLlmAsJudgeEvaluatorRequest = CreateLlmAsJudgeEvaluatorRequest;
type index$3_DateTimeEvaluationRuleFilter = DateTimeEvaluationRuleFilter;
type index$3_DeleteEvaluationRuleResponse = DeleteEvaluationRuleResponse;
type index$3_DeleteEvaluatorResponse = DeleteEvaluatorResponse;
type index$3_EvaluationRule = EvaluationRule;
declare const index$3_EvaluationRuleArrayOptionsFilterOperator: typeof EvaluationRuleArrayOptionsFilterOperator;
declare const index$3_EvaluationRuleBooleanFilterOperator: typeof EvaluationRuleBooleanFilterOperator;
type index$3_EvaluationRuleEvaluator = EvaluationRuleEvaluator;
type index$3_EvaluationRuleEvaluatorReference = EvaluationRuleEvaluatorReference;
declare const index$3_EvaluationRuleFilter: typeof EvaluationRuleFilter;
type index$3_EvaluationRuleMapping = EvaluationRuleMapping;
declare const index$3_EvaluationRuleMappingSource: typeof EvaluationRuleMappingSource;
declare const index$3_EvaluationRuleNullFilterOperator: typeof EvaluationRuleNullFilterOperator;
declare const index$3_EvaluationRuleNumberFilterOperator: typeof EvaluationRuleNumberFilterOperator;
declare const index$3_EvaluationRuleOptionsFilterOperator: typeof EvaluationRuleOptionsFilterOperator;
declare const index$3_EvaluationRuleStatus: typeof EvaluationRuleStatus;
declare const index$3_EvaluationRuleStringFilterOperator: typeof EvaluationRuleStringFilterOperator;
declare const index$3_EvaluationRuleTarget: typeof EvaluationRuleTarget;
declare const index$3_Evaluator: typeof Evaluator;
type index$3_EvaluatorBase = EvaluatorBase;
type index$3_EvaluatorModelConfig = EvaluatorModelConfig;
declare const index$3_EvaluatorOutputDataType: typeof EvaluatorOutputDataType;
declare const index$3_EvaluatorOutputDefinition: typeof EvaluatorOutputDefinition;
type index$3_EvaluatorOutputFieldDefinition = EvaluatorOutputFieldDefinition;
declare const index$3_EvaluatorScope: typeof EvaluatorScope;
declare const index$3_EvaluatorType: typeof EvaluatorType;
type index$3_InternalServerError = InternalServerError;
declare const index$3_InternalServerError: typeof InternalServerError;
type index$3_ListEvaluationRulesRequest = ListEvaluationRulesRequest;
type index$3_ListEvaluatorsRequest = ListEvaluatorsRequest;
type index$3_LlmAsJudgeEvaluationRuleEvaluatorReference = LlmAsJudgeEvaluationRuleEvaluatorReference;
type index$3_LlmAsJudgeEvaluator = LlmAsJudgeEvaluator;
declare const index$3_LlmAsJudgeEvaluatorType: typeof LlmAsJudgeEvaluatorType;
type index$3_MethodNotAllowedError = MethodNotAllowedError;
declare const index$3_MethodNotAllowedError: typeof MethodNotAllowedError;
type index$3_NotFoundError = NotFoundError;
declare const index$3_NotFoundError: typeof NotFoundError;
type index$3_NullEvaluationRuleFilter = NullEvaluationRuleFilter;
type index$3_NumberEvaluationRuleFilter = NumberEvaluationRuleFilter;
type index$3_NumberObjectEvaluationRuleFilter = NumberObjectEvaluationRuleFilter;
type index$3_PublicApiError = PublicApiError;
declare const index$3_PublicApiErrorCode: typeof PublicApiErrorCode;
type index$3_PublicApiErrorDetails = PublicApiErrorDetails;
type index$3_PublicApiValidationIssue = PublicApiValidationIssue;
type index$3_PublicBooleanEvaluatorOutputDefinition = PublicBooleanEvaluatorOutputDefinition;
type index$3_PublicCategoricalEvaluatorOutputDefinition = PublicCategoricalEvaluatorOutputDefinition;
type index$3_PublicCategoricalEvaluatorOutputScoreDefinition = PublicCategoricalEvaluatorOutputScoreDefinition;
declare const index$3_PublicEvaluatorOutputDefinition: typeof PublicEvaluatorOutputDefinition;
type index$3_PublicNumericEvaluatorOutputDefinition = PublicNumericEvaluatorOutputDefinition;
type index$3_StringEvaluationRuleFilter = StringEvaluationRuleFilter;
type index$3_StringObjectEvaluationRuleFilter = StringObjectEvaluationRuleFilter;
type index$3_StringOptionsEvaluationRuleFilter = StringOptionsEvaluationRuleFilter;
type index$3_TooManyRequestsError = TooManyRequestsError;
declare const index$3_TooManyRequestsError: typeof TooManyRequestsError;
type index$3_UnauthorizedError = UnauthorizedError;
declare const index$3_UnauthorizedError: typeof UnauthorizedError;
type index$3_UnprocessableContentError = UnprocessableContentError;
declare const index$3_UnprocessableContentError: typeof UnprocessableContentError;
type index$3_UpdateEvaluationRuleRequest = UpdateEvaluationRuleRequest;
declare namespace index$3 {
  export { index$3_AccessDeniedError as AccessDeniedError, type index$3_ArrayOptionsEvaluationRuleFilter as ArrayOptionsEvaluationRuleFilter, index$3_BadRequestError as BadRequestError, type index$3_BooleanEvaluationRuleFilter as BooleanEvaluationRuleFilter, type index$3_CategoryOptionsEvaluationRuleFilter as CategoryOptionsEvaluationRuleFilter, type index$3_CodeEvaluationRuleEvaluatorReference as CodeEvaluationRuleEvaluatorReference, type index$3_CodeEvaluator as CodeEvaluator, index$3_CodeEvaluatorSourceCodeLanguage as CodeEvaluatorSourceCodeLanguage, index$3_ConflictError as ConflictError, type index$3_CreateCodeEvaluationRuleRequest as CreateCodeEvaluationRuleRequest, type index$3_CreateCodeEvaluatorRequest as CreateCodeEvaluatorRequest, type index$3_CreateEvaluationRuleRequest as CreateEvaluationRuleRequest, index$3_CreateEvaluatorRequest as CreateEvaluatorRequest, type index$3_CreateLlmAsJudgeEvaluationRuleRequest as CreateLlmAsJudgeEvaluationRuleRequest, type index$3_CreateLlmAsJudgeEvaluatorRequest as CreateLlmAsJudgeEvaluatorRequest, type index$3_DateTimeEvaluationRuleFilter as DateTimeEvaluationRuleFilter, type index$3_DeleteEvaluationRuleResponse as DeleteEvaluationRuleResponse, type index$3_DeleteEvaluatorResponse as DeleteEvaluatorResponse, type index$3_EvaluationRule as EvaluationRule, index$3_EvaluationRuleArrayOptionsFilterOperator as EvaluationRuleArrayOptionsFilterOperator, index$3_EvaluationRuleBooleanFilterOperator as EvaluationRuleBooleanFilterOperator, type index$3_EvaluationRuleEvaluator as EvaluationRuleEvaluator, type index$3_EvaluationRuleEvaluatorReference as EvaluationRuleEvaluatorReference, index$3_EvaluationRuleFilter as EvaluationRuleFilter, type index$3_EvaluationRuleMapping as EvaluationRuleMapping, index$3_EvaluationRuleMappingSource as EvaluationRuleMappingSource, index$3_EvaluationRuleNullFilterOperator as EvaluationRuleNullFilterOperator, index$3_EvaluationRuleNumberFilterOperator as EvaluationRuleNumberFilterOperator, index$3_EvaluationRuleOptionsFilterOperator as EvaluationRuleOptionsFilterOperator, index$3_EvaluationRuleStatus as EvaluationRuleStatus, index$3_EvaluationRuleStringFilterOperator as EvaluationRuleStringFilterOperator, index$3_EvaluationRuleTarget as EvaluationRuleTarget, type EvaluationRules$1 as EvaluationRules, index$3_Evaluator as Evaluator, type index$3_EvaluatorBase as EvaluatorBase, type index$3_EvaluatorModelConfig as EvaluatorModelConfig, index$3_EvaluatorOutputDataType as EvaluatorOutputDataType, index$3_EvaluatorOutputDefinition as EvaluatorOutputDefinition, type index$3_EvaluatorOutputFieldDefinition as EvaluatorOutputFieldDefinition, index$3_EvaluatorScope as EvaluatorScope, index$3_EvaluatorType as EvaluatorType, type Evaluators$1 as Evaluators, index$3_InternalServerError as InternalServerError, type index$3_ListEvaluationRulesRequest as ListEvaluationRulesRequest, type index$3_ListEvaluatorsRequest as ListEvaluatorsRequest, type index$3_LlmAsJudgeEvaluationRuleEvaluatorReference as LlmAsJudgeEvaluationRuleEvaluatorReference, type index$3_LlmAsJudgeEvaluator as LlmAsJudgeEvaluator, index$3_LlmAsJudgeEvaluatorType as LlmAsJudgeEvaluatorType, index$3_MethodNotAllowedError as MethodNotAllowedError, index$3_NotFoundError as NotFoundError, type index$3_NullEvaluationRuleFilter as NullEvaluationRuleFilter, type index$3_NumberEvaluationRuleFilter as NumberEvaluationRuleFilter, type index$3_NumberObjectEvaluationRuleFilter as NumberObjectEvaluationRuleFilter, type index$3_PublicApiError as PublicApiError, index$3_PublicApiErrorCode as PublicApiErrorCode, type index$3_PublicApiErrorDetails as PublicApiErrorDetails, type index$3_PublicApiValidationIssue as PublicApiValidationIssue, type index$3_PublicBooleanEvaluatorOutputDefinition as PublicBooleanEvaluatorOutputDefinition, type index$3_PublicCategoricalEvaluatorOutputDefinition as PublicCategoricalEvaluatorOutputDefinition, type index$3_PublicCategoricalEvaluatorOutputScoreDefinition as PublicCategoricalEvaluatorOutputScoreDefinition, index$3_PublicEvaluatorOutputDefinition as PublicEvaluatorOutputDefinition, type index$3_PublicNumericEvaluatorOutputDefinition as PublicNumericEvaluatorOutputDefinition, type index$3_StringEvaluationRuleFilter as StringEvaluationRuleFilter, type index$3_StringObjectEvaluationRuleFilter as StringObjectEvaluationRuleFilter, type index$3_StringOptionsEvaluationRuleFilter as StringOptionsEvaluationRuleFilter, index$3_TooManyRequestsError as TooManyRequestsError, index$3_UnauthorizedError as UnauthorizedError, index$3_UnprocessableContentError as UnprocessableContentError, type index$3_UpdateEvaluationRuleRequest as UpdateEvaluationRuleRequest, index$7 as commons, index$6 as errors, index$5 as evaluationRules, index$4 as evaluators };
}
...
declare class LlmConnections {
     ...
     */
    delete(id: string, requestOptions?: LlmConnections.RequestOptions): HttpResponsePromise<DeleteLlmConnectionResponse>;
    private __delete;
    protected _getAuthorizationHeader(): Promise<string | undefined>;
}
...
declare class ScoresV3 {
     ...
     */
    getManyV3(request?: GetScoresV3Request, requestOptions?: ScoresV3.RequestOptions): HttpResponsePromise<GetScoresV3Response>;
    private __getManyV3;
    protected _getAuthorizationHeader(): Promise<string | undefined>;
}
...
declare namespace EvaluationRules {
    interface Options {
        environment: Supplier<string>;
        /** Specify a custom URL to connect the client to. */
        baseUrl?: Supplier<string>;
...
declare class EvaluationRules {
     ...
     *     })
     */
    create(request: CreateEvaluationRuleRequest, requestOptions?: EvaluationRules.RequestOptions): HttpResponsePromise<EvaluationRule>;
    private __create;
    /**
     ...
     */
    list(request?: ListEvaluationRulesRequest, requestOptions?: EvaluationRules.RequestOptions): HttpResponsePromise<EvaluationRules$1>;
    private __list;
    /**
     ...
     */
    get(evaluationRuleId: string, requestOptions?: EvaluationRules.RequestOptions): HttpResponsePromise<EvaluationRule>;
    private __get;
    /**
     ...
     *     })
     */
    update(evaluationRuleId: string, request: UpdateEvaluationRuleRequest, requestOptions?: EvaluationRules.RequestOptions): HttpResponsePromise<EvaluationRule>;
    private __update;
    /**
     ...
     */
    delete(evaluationRuleId: string, requestOptions?: EvaluationRules.RequestOptions): HttpResponsePromise<DeleteEvaluationRuleResponse>;
    private __delete;
    protected _getAuthorizationHeader(): Promise<string | undefined>;
}
...
declare class Evaluators {
     ...
     *     })
     */
    create(request: CreateEvaluatorRequest, requestOptions?: Evaluators.RequestOptions): HttpResponsePromise<Evaluator>;
    private __create;
    /**
     ...
     */
    list(request?: ListEvaluatorsRequest, requestOptions?: Evaluators.RequestOptions): HttpResponsePromise<Evaluators$1>;
    private __list;
    /**
     ...
     */
    get(evaluatorId: string, requestOptions?: Evaluators.RequestOptions): HttpResponsePromise<Evaluator>;
    private __get;
    /**
     * Delete an evaluator.
     *
     ...
     */
    delete(evaluatorId: string, requestOptions?: Evaluators.RequestOptions): HttpResponsePromise<DeleteEvaluatorResponse>;
    private __delete;
    protected _getAuthorizationHeader(): Promise<string | undefined>;
}
...
declare class Unstable {
    ...
    get evaluationRules(): EvaluationRules;
 ...
 * @internal
 */
declare const LANGFUSE_TRACE_ID_BAGGAGE_KEY = "langfuse_trace_id";
/**
 ...
 * @internal
 */
declare function getLangfuseTraceIdFromBaggage(context: Context): string | undefined;
/**
 ...
 * @internal
 */
declare function setLangfuseTraceIdInBaggage(context: Context, traceId: string): Context;
/**
