...
function buildBackgroundTaskWorkflow(manager) {
  const runAttemptStep = chunkD37QL5LB_cjs.createStep2({
    id: "run-attempt",
  ...
  const classifyOutcomeStep = chunkD37QL5LB_cjs.createStep2({
    id: "classify-outcome",
  ...
  const attemptBodyWorkflow = chunkD37QL5LB_cjs.createWorkflow2({
    id: `${chunk23FX5JPX_cjs.BACKGROUND_TASK_WORKFLOW_ID}__attempt`,
    inputSchema: bodyIOSchema,
    outputSchema: bodyOutputSchema,
  ...
  return chunkD37QL5LB_cjs.createWorkflow2({
    id: chunk23FX5JPX_cjs.BACKGROUND_TASK_WORKFLOW_ID,
    inputSchema,
    outputSchema: bodyOutputSchema,
...
Object.defineProperty(exports, "BACKGROUND_TASK_WORKFLOW_ID", {
  enumerable: true,
  get: function () { return chunk23FX5JPX_cjs.BACKGROUND_TASK_WORKFLOW_ID; }
});
exports.buildBackgroundTaskWorkflow = buildBackgroundTaskWorkflow;
//# sourceMappingURL=workflow-JX3Y4XAT.cjs.map
//# sourceMappingURL=workflow-JX3Y4XAT.cjs.map