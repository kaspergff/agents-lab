...
var unicodeNormalizerProvider = {
  ...
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.UnicodeNormalizer(config);
  }
};
var tokenLimiterProvider = {
  ...
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.TokenLimiterProcessor(
      config
    );
  }
};
var toolCallFilterProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.ToolCallFilter(config);
  }
};
var batchPartsProvider = {
  ...
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.BatchPartsProcessor(config);
  }
};
var moderationProvider = {
  ...
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.ModerationProcessor(config);
  }
};
var promptInjectionDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.PromptInjectionDetector(config);
  }
};
var piiDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.PIIDetector(config);
  }
};
var languageDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.LanguageDetector(config);
  }
};
var systemPromptScrubberProvider = {
  ...
  createProcessor(config) {
    return new chunkD37QL5LB_cjs.SystemPromptScrubber(config);
  }
};
