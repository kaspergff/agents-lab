import { ModelsDevGateway, createOpenRouter } from './chunk-DC5MZPEV.js';
import { NetlifyGateway } from './chunk-47D62JH6.js';
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-3UU4TZYF.js');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-4HRLO2A6.js');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-PSZTAQ3D.js');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-7NQESWD7.js');
...
//# sourceMappingURL=chunk-Q4CL7YBQ.js.map
//# sourceMappingURL=chunk-Q4CL7YBQ.js.map