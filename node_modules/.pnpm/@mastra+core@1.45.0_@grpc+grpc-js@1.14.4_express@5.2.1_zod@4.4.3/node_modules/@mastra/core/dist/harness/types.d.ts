...
export type HarnessRequestStateUpdater<TState, TResult> = (state: Readonly<TState>) => HarnessRequestStateUpdateResult<TState, TResult> | Promise<HarnessRequestStateUpdateResult<TState, TResult>>;
