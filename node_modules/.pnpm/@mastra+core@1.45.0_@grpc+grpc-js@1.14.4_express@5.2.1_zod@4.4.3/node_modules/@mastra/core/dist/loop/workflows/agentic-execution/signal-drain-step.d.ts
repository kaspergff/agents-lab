...
export declare function createSignalDrainStep<Tools extends ToolSet = ToolSet, OUTPUT = undefined>({ _internal, controller, runId, messageList, rotateResponseMessageId, }: OuterLLMRun<Tools, OUTPUT>): import("../../../workflows").Step<"signalDrainStep", unknown, {
    messageId: string;
    messages: {
        all: any[];
        user: any[];
